...
$mod_strings = array(
    ...
    'ERR_PERFORM_NO_TCPIP' => '<b> Chúng tôi không thể tự phát hiện kết nối internet.</b> Khi bạn có kết nối, vui lòng truy cập <a href=\\"https://www.suitecrm.com\\">https: //www.suitecrm. com</a>để đăng ký với SuiteCRM. Bằng cách cho chúng tôi biết một chút về cách công ty của bạn lên kế hoạch sử dụng SuiteCRM, chúng tôi có thể đảm bảo chúng tôi luôn cung cấp đúng ứng dụng cho nhu cầu kinh doanh của bạn.',
