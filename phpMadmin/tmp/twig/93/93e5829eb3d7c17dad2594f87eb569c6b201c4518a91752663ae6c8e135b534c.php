...
class __TwigTemplate_c5121e1c1614bb3b079d2d6014adf35e8f7fc854ae32c48e8db8ede9b58294ec extends Template
{
    private $source;
    private $macros = [];
    ...
    <select id=\"id_refreshRate\" class=\"refreshRate\" name=\"refreshRate\">
      ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["rate"]) {
            ...
            echo "\"";
            echo (((0 === twig_compare($context["rate"], 5))) ? (" selected") : (""));
            echo ">
          ";
            // line 38
            if ((-1 === twig_compare($context["rate"], 60))) {
                // line 39
                echo "            ";
                if ((0 === twig_compare($context["rate"], 1))) {
                    // line 40
                    echo "              ";
            ...
            ";
                ...
                // line 45
                echo "            ";
                if ((0 === twig_compare(($context["rate"] / 60), 1))) {
                    // line 46
                    echo "              ";
...
";
    ...
    {
        return new Source("", "server/status/processes/index.twig", "/home/bmvmbwsite_1801/public_html/phpMadmin/templates/server/status/processes/index.twig");
    }
}
