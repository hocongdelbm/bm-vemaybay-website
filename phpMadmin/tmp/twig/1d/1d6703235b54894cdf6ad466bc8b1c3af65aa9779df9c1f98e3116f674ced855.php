...
class __TwigTemplate_099c67a6dd6b14249dd4d6e7c8b3a52882baf560068fe8d61018a09deb3f0334 extends Template
{
    private $source;
    private $macros = [];
...
echo _gettext("Descending");
                ...
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["column"], "sort_order", [], "any", false, false, false, 12), "DESC"))) ? ("none") : ("inline"));
                echo "\">
                <img class=\"icon ic_s_asc soimg hide\" alt=\"";
echo _gettext("Ascending");
                // line 14
                echo "\" src=\"themes/dot.gif\" style=\"display: ";
                echo (((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["column"], "sort_order", [], "any", false, false, false, 14), "DESC"))) ? ("inline") : ("none"));
                echo "\">
              ";
            }
            // line 16
...
echo _gettext("Kill");
          ...
          <td>
            ";
            // line 49
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["row"], "user", [], "any", false, false, false, 49), "system user"))) {
                // line 50
                echo "              <a href=\"";
...
$context["row"], "db", [], "any", false, false, false, 53), "tablename" => "", "routinename" => ""]);
          ...
          <td>
            ";
            // line 65
            if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, $context["row"], "db", [], "any", false, false, false, 65), ""))) {
                // line 66
                echo "              <a href=\"";
...
";
    ...
    {
        return new Source("", "server/status/processes/list.twig", "/home/bmvmbwsite_1801/public_html/phpMadmin/templates/server/status/processes/list.twig");
    }
}
