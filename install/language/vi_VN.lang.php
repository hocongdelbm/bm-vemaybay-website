...
$mod_strings = array(
    ...
    'ERR_CHECKSYS_JSON_NOT_AVAILABLE' => "Không tìm thấy các chức năng được liên kết với Thư viện phân tích cú pháp JSON mà ứng dụng SuiteCRM cần. Bạn có thể cần bỏ ghi chú phần mở rộng trong tệp php.ini hoặc biên dịch lại bằng tệp nhị phân phù hợp, tùy thuộc vào phiên bản PHP của bạn. Vui lòng tham khảo Hướng dẫn sử dụng PHP của bạn để biết thêm thông tin.",
    ...
    'ERR_DB_LOGIN_FAILURE_SHORT' => 'Lỗi kết nối cơ sở dữ liệu: Tên máy chủ, cổng, tên người dùng và / hoặc mật khẩu cơ sở dữ liệu được cung cấp không hợp lệ.',
    ...
    'ERR_URL_BLANK' => 'Cung cấp các URL cơ sở cho SuiteCRM.',
    ...
    'LBL_CHECKSYS_JSON' => 'Phân tích cú pháp JSON',
    ...
    'LBL_DBCONF_DB_PORT' => 'Cổng cơ sở dữ liệu',
    ...
    'LBL_SILENT_INSTALL_SUCCESS' => 'SuiteCRM đã được cài đặt thành công.',
    'LBL_SILENT_INSTALL_FAILED' => 'Cài đặt SuiteCRM không thành công.',
...
$contact_user_link_guid',
    ...
    'LBL_SYS_CHECK_WARNING' => 'Bỏ qua cảnh báo kiểm tra hệ thống',
    'LBL_PROCEED' => 'TIẾP TỤC',
    'LBL_CONFIG' => 'CẤU HÌNH',
    'LBL_VALIDATION_ERRORS' => 'Có lỗi xác thực, không thể thực hiện hành động.'
);
