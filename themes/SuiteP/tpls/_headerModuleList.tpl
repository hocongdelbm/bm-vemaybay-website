{literal}
     ...
     <script>
          $(document).ready(function() {
               ...
               // SVG icons
               const sunIcon =
                    `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" data-icon="sun" class="m-0 bi bi-brightness-high" viewBox="0 0 16 16"><path d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6m0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8M8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0m0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13m8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5M3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8m10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0m-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0m9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707M4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708"/></svg>`;
               const moonIcon =
                    `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" data-icon="moon" class="m-0 bi bi-moon" viewBox="0 0 16 16"><path d="M6 .278a.77.77 0 0 1 .08.858 7.2 7.2 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277q.792-.001 1.533-.16a.79.79 0 0 1 .81.316.73.73 0 0 1-.031.893A8.35 8.35 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.75.75 0 0 1 6 .278M4.858 1.311A7.27 7.27 0 0 0 1.025 7.71c0 4.02 3.279 7.276 7.319 7.276a7.32 7.32 0 0 0 5.205-2.162q-.506.063-1.029.063c-4.61 0-8.343-3.714-8.343-8.29 0-1.167.242-2.278.681-3.286"/></svg>`;
               ...
               if (themeToggleItems) {
                    themeToggleItems.forEach(item => {
                         item.classList.toggle("active", item.getAttribute("data-bs-theme-value") ===
                              savedTheme);
                    });
                    ...
                    themeToggleItems.forEach(item => {
                         item.addEventListener("click", function() {
                              ...
                              themeIcon.innerHTML = selectedTheme === "light" ? sunIcon :
                                   moonIcon;
                    ...
                    <div class="d-flex header-navbar__top w-100 align-items-center">
                         ...
                         {if $THEME_CONFIG.display_sidebar}
                              <aside id="sidebar-horizontal" class="sidebar sidebar-horizontal d-flex align-items-center">
                                   <ul class="list-menu-horizontal sidebar-nav d-flex align-items-center gap-2"
                                        id="sidebar-nav">
                                        <!-- Action Side Bar -->
                                        {if $USE_GROUP_TABS}
                                                       ...
                                                       <li class="nav-item">
                                                            <a href="#" class="nav-link collapsed">
                                                                 ...
                                                                 {elseif $group == 'Bán hàng' || $group == 'Sales'}
                                                                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                           fill="currentColor" class="bi bi-basket3 menu-icon"
                                                                           viewBox="0 0 16 16">
                                                                           <path
                                                                 ...
                                                                 {elseif $group == 'Kế toán' || $group == 'Accounting'}
                                                                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                           fill="currentColor" class="bi bi-currency-exchange"
                                                                           viewBox="0 0 16 16">
                                                                           <path
                                                                 ...
                                                                 <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                      fill="currentColor" class="bi bi-chevron-down menu-arrow me-0"
                                                                      viewBox="0 0 16 16">
                                                                      <path fill-rule="evenodd"
                                                            ...
                                                            <ul class="sidebar-nav sub-menu nav-content collapse box-list">
                                                                 ...
                                                                 {foreach from=$modules.modules item=module key=modulekey}
                                                                      ...
                                                                      <li class="box-item">
                                                                           ...
                                                                           <a
                                                                                href="{sugar_link id=$moduleTabId module=$modulekey link_only=1 data=$module extraparams=$extraparams}">
                                                                                {$module}
                                                                           </a>
                                                                      </li>
                                                                 {/foreach}
                                                                 ...
                                                                 {foreach from=$modules.extra item=submodulename key=submodule}
                                                                      <li class="box-item box-item__extra">
                                                                           <a
                                                                                href="{sugar_link module=$submodule link_only=1 extraparams=$extraparams}">
                                                                                {$submodulename}
                                                                           </a>
                                                                      </li>
                                                                 {/foreach}
                                        ...
                                        {else}
                                             <li class="navbar-brand-container nav-item">
                                                  <a class="navbar-brand with-home-icon nav-link"
                                                       href="index.php?module=Home&action=index">
                                                       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                            fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
                                                            <path
                                                                 d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5ZM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5Z" />
                         ...
                         <div class="navbar-menu-wrapper d-flex align-items-stretch">
                              <ul class="navbar-nav navbar-nav-right">
                                   ...
                                   {if $AUTHENTICATED}
                                        <li id="change_user_status" class="agent-status" style="display:none;">
                                             <button type="button" class="agent-status__pill" id="agent_status_pill">
                                                  ...
                                                  <svg class="agent-status__caret" xmlns="http://www.w3.org/2000/svg"
                                             ...
                                             <ul class="agent-status__menu" id="agent_status_menu">
                                                  <li class="agent-status__option" data-status="Available">
                                                       ...
                                                       <svg class="agent-status__tick" xmlns="http://www.w3.org/2000/svg"
                                                            width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                                                            <path
                                                                 d="M13.485 1.929a.75.75 0 0 1 .086 1.056l-7 8.5a.75.75 0 0 1-1.11.05l-3.5-3.5a.75.75 0 1 1 1.06-1.06l2.93 2.93 6.478-7.87a.75.75 0 0 1 1.056-.086z" />
                                                       </svg>
                                                  </li>
                                                  ...
                                                  <div class="numpad">
                                                       <div class="d-flex flex-column gap-3">
                                                            ...
                                                            <div class="flex-start gap-3">
                                                                 <label for="select-phone-outbound"
                                                                      class="label text-nowrap">Số gọi ra:</label>
                                                                 <select name="select-phone-outbound"
                                                                      id="select-phone-outbound" class="box-select w-100">
                                                                      <option value=""></option>
                                                                                ...
                                                                                <optgroup label="{$network_provider|capitalize}">
                                                                                     {foreach from=$phones item=phone}
                                                                                          {if $phone.proxy|default:''|trim != ''}
                                                                                               <option
                                                                                                    value="{$phone.name|trim}@{$phone.proxy|trim}">
                                                                                                    {$phone.name|trim}
                                                                                                    {if $phone.brand_name|trim != ''}
                                                                                                    ({$phone.brand_name|lower|capitalize}){/if}
                                                                                               </option>
                                                                                          {/if}
                                                                                     {/foreach}
                                                                                </optgroup>
                                                            ...
                                                            <div class="flex-start gap-3">
                                                                 <label for="select-phone-support"
                                                                      class="label text-nowrap">Hotline hãng:</label>
                                                                 <select name="select-phone-support"
                                                                      id="select-phone-support" class="box-select w-100">
                                                                      <option value=""></option>
                                                            ...
                                                            <div class="numbers">
                                                                 ...
                                                                 <button class="number" type="button" name="clear"
                                                                      onclick="removeNumber(this)">
                                                                      <span class="pin_font">
                                                            ...
                                                            <div class="call-button--wrap flex-between">
                                                                 <button
                                                                      class="btn btn-calling flex-fill btn-voiceip-calling btn-voiceip-calling-zalo"
                                                                      type="button" id="btn-voiceip-main-zalo">
                                                                      Zalo
                                                                 </button>
                                                                 <button
                                                                      class="btn-calling flex-fill btn-voiceip-calling btn-voiceip-calling-teco"
                                                                      type="button" id="btn-voiceip-main-calling">
                                                                      Gọi
                                                                 </button>
                                                            </div>
                                                       </div>
                                   ...
                                   {if $CURRENT_USER == 'hungnh'}
                                        <li class="item-theme-mode nav-item dropdown me-2 me-xl-0">
                                             <a class="nav-link dropdown-toggle hide-arrow theme-icon-active" id="nav-theme"
                                             ...
                                             <ul class="dropdown-menu dropdown-menu-end box-list min-w-150 position-absolute"
                                                  aria-labelledby="nav-theme-text">
                                                  <li class="box-item mb-2">
                                                       <a type="button" class="rounded flex-start active"
                                                            data-bs-theme-value="light">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                                 fill="currentColor" data-icon="sun"
                                                                 class="m-0 bi bi-brightness-high" viewBox="0 0 16 16">
                                                                 <path
                                                                      d="M8 11a3 3 0 1 1 0-6 3 3 0 0 1 0 6m0 1a4 4 0 1 0 0-8 4 4 0 0 0 0 8M8 0a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 0m0 13a.5.5 0 0 1 .5.5v2a.5.5 0 0 1-1 0v-2A.5.5 0 0 1 8 13m8-5a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2a.5.5 0 0 1 .5.5M3 8a.5.5 0 0 1-.5.5h-2a.5.5 0 0 1 0-1h2A.5.5 0 0 1 3 8m10.657-5.657a.5.5 0 0 1 0 .707l-1.414 1.415a.5.5 0 1 1-.707-.708l1.414-1.414a.5.5 0 0 1 .707 0m-9.193 9.193a.5.5 0 0 1 0 .707L3.05 13.657a.5.5 0 0 1-.707-.707l1.414-1.414a.5.5 0 0 1 .707 0m9.193 2.121a.5.5 0 0 1-.707 0l-1.414-1.414a.5.5 0 0 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .707M4.464 4.465a.5.5 0 0 1-.707 0L2.343 3.05a.5.5 0 1 1 .707-.707l1.414 1.414a.5.5 0 0 1 0 .708" />
                                                            </svg>
                                                            <span>Sáng</span>
                                                  ...
                                                  <li class="box-item">
                                                       <a type="button" class="rounded flex-start"
                                                            data-bs-theme-value="dark">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                                 fill="currentColor" data-icon="moon" class="m-0 bi bi-moon"
                                                                 viewBox="0 0 16 16">
                                                                 <path
                                   ...
                                   <li id="quickcreatetop" class="nav-item navbar-dropdown dropdown-shortcuts dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end p-0">
                                             <div class="dropdown-menu-header border-bottom">
                                                  <div
                                                       class="dropdown-header d-flex align-items-center py-2 bg-primary">
                                                  ...
                                                  <div class="row row-bordered overflow-visible g-0">
                                                       <div class="dropdown-shortcuts-item col">
                                                            ...
                                                            <a class="stretched-link"
                                                                 href="index.php?module=EC_Receipt_Voucher&action=EditView&return_module=EC_Receipt_Voucher&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="EC_Receipt_Voucher" label="LBL_MODULE_NAME"}</a>
                                                       </div>
                                                       ...
                                                       <div class="dropdown-shortcuts-item col">
                                                            ...
                                                            <a class="stretched-link"
                                                                 href="index.php?module=EC_Payment_Voucher&action=EditView&return_module=EC_Payment_Voucher&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="EC_Payment_Voucher" label="LBL_MODULE_NAME"}</a>
                                                       </div>
                                                  </div>
                                                  <div class="row row-bordered overflow-visible g-0">
                                                       <div class="dropdown-shortcuts-item col">
                                                            ...
                                                            <a class="stretched-link"
                                                                 href="index.php?module=EC_HoanVe&action=EditView&return_module=EC_HoanVe&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="EC_HoanVe" label="LBL_MODULE_NAME"}</a>
                                                       </div>
                                                       ...
                                                       <div class="dropdown-shortcuts-item col">
                                                            ...
                                                            <a class="stretched-link"
                                                                 href="index.php?module=EC_LeaveAbsences&action=EditView&return_module=EC_LeaveAbsences&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="EC_LeaveAbsences" label="LBL_MODULE_NAME"}</a>
                                                       </div>
                                                  </div>
                                                  <div class="row row-bordered overflow-visible g-0">
                                                       <div class="dropdown-shortcuts-item col">
                                                            ...
                                                            <a class="stretched-link"
                                                                 href="index.php?module=EC_ChuyenTienNoiBo&action=EditView&return_module=EC_ChuyenTienNoiBo&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="EC_ChuyenTienNoiBo" label="LBL_MODULE_NAME"}</a>
                                                       </div>
                                                       ...
                                                       <div class="dropdown-shortcuts-item col">
                                                            ...
                                                            <a class="stretched-link"
                                                                 href="index.php?module=EC_HoaDonBan&action=EditView&return_module=EC_HoaDonBan&return_action=DetailView">{$APP.LBL_QUICK_CREATE}{sugar_translate module="EC_HoaDonBan" label="LBL_MODULE_NAME"}</a>
                                                       </div>
                                                  </div>
                                             </div>
                                        </div>
                                   ...
                                   <li id="desktop_notifications" class="nav-item dropdown desktop_notifications">
                                        <a class="nav-link count-indicator dropdown-toggle hide-arrow"
                                             id="notificationDropdown" href="javascript:void(0)"
                                             data-bs-toggle="dropdown" data-bs-auto-close="outside"
                                             aria-expanded="true">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                  viewBox="0 0 24 24" style="fill: #bba8bff5">
                                                  <path
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown box-list"
                                             ...
                                             <div class="d-flex flex-column gap-2">
                                                  <div class="notification-header">
                                                       <div class="flex-between gap-2">
                                                            ...
                                                            <div class="dropdown">
                                                                 <button type="button"
                                                                      class="btn-more-notify btn p-0 dropdown-toggle hide-arrow"
                                                                 ...
                                                                 <div
                                                                      class="dropdown-more-notify dropdown-menu dropdown-menu-end">
                                                                      <a class="flex-start gap-1 dropdown-item cursor-pointer clear-all-alerts-btn"
                                                                           ...
                                                                           <span
                                                                                class="">{sugar_translate label="LBL_CLEARALL"}</span>
                                                                      </a>
                                                                      <a class="flex-start gap-1 dropdown-item cursor-pointer mark-all-alerts-btn"
                                                                           href="javascript:void(0);">
                                                                           <svg xmlns="http://www.w3.org/2000/svg"
                                                                                width="24" height="24"
                                                                                viewBox="0 0 24 24" fill="currentColor">
                                                       ...
                                                       <div class="flex-between gap-2">
                                                            <div class="flex-start">
                                                                 <div onclick="Alerts.getAlertUnread();"
                                                                      class="notification-show notification-unread active">
                                                                      <span>Chưa đọc</span></div>
                                                                 <div onclick="Alerts.getAllAlerts();"
                                                                      class="notification-show notification-all">
                                                                      <span>Tất cả</span></div>
                                                            </div>
                                                            <a href="index.php?module=Alerts&action=Listview&return_module=Alerts&return_action=index"
                                                                 class="notification-view-all"><span>Xem tất
                                                                      cả</span></a>
                                                       </div>
                                                  </div>
                                                  ...
                                                  {if $IS_ADMIN}
                                                       <div class="notification-footer">
                                                            <a href="index.php?module=Alerts&action=EditView&return_module=Alerts&return_action=index"
                                                                 class="btn btn-primary w-100 py-2">Tạo thông báo</a>
                                                       </div>
                                                  {/if}
                                             </div>
                                        </div>
                                   ...
                                   <li class="nav-item dropdown">
                                        <button id="messenger-chat-widget" type="button" aria-label="Mở Messenger">
                                             <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#163bf3"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 1.25C6.06294 1.25 1.25 6.06294 1.25 12C1.25 13.8563 1.72113 15.6046 2.55076 17.1298L1.76267 21.3627C1.71742 21.6058 1.79485 21.8555 1.96967 22.0303C2.14448 22.2051 2.39422 22.2826 2.63727 22.2373L6.87016 21.4493C8.39536 22.2788 10.1437 22.75 12 22.75C17.937 22.75 22.75 17.937 22.75 12C22.75 6.06293 17.937 1.25 12 1.25ZM17 10.75C16.3097 10.75 15.75 11.3097 15.75 12C15.75 12.6903 16.3097 13.25 17 13.25C17.6903 13.25 18.25 12.6903 18.25 12C18.25 11.3097 17.6903 10.75 17 10.75ZM10.75 12C10.75 11.3097 11.3097 10.75 12 10.75C12.6903 10.75 13.25 11.3097 13.25 12C13.25 12.6903 12.6903 13.25 12 13.25C11.3097 13.25 10.75 12.6903 10.75 12ZM7 10.75C6.30961 10.75 5.75 11.3097 5.75 12C5.75 12.6903 6.30961 13.25 7 13.25C7.69039 13.25 8.25 12.6903 8.25 12C8.25 11.3097 7.69039 10.75 7 10.75Z" fill="#163bf3"></path></svg>
                                             <span class="messenger-chat-unread-badge" aria-live="polite" aria-label="0 tin nhắn chưa đọc"></span>
                                        </button>
                                   </li>
                                   <!-- PROFILE -->
                                   <li id="globalLinks" class="nav-item nav-profile dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end navbar-dropdown box-list user-dropdown user-menu"
                                             ...
                                             <li class="box-item">
                                                  ...
                                                  <a
                                                       href='index.php?module=Users&action=EditView&record={$CURRENT_USER_ID}'>
                                                       {$APP.LBL_PROFILE}
                                                  </a>
                                             </li>
                                             {foreach from=$GCLS item=GCL name=gcl key=gcl_key}
                                                  <li class="box-item">
                                                       {if $gcl_key == 'employees'} <svg xmlns="http://www.w3.org/2000/svg"
                                                                 width="16" height="16" fill="currentColor" class="bi bi-people"
                                                                 viewBox="0 0 16 16">
                                                                 <path
                                                                      d="M15 14s1 0 1-1-1-4-5-4-5 3-5 4 1 1 1 1h8Zm-7.978-1A.261.261 0 0 1 7 12.996c.001-.264.167-1.03.76-1.72C8.312 10.629 9.282 10 11 10c1.717 0 2.687.63 3.24 1.276.593.69.758 1.457.76 1.72l-.008.002a.274.274 0 0 1-.014.002H7.022ZM11 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM6.936 9.28a5.88 5.88 0 0 0-1.23-.247A7.35 7.35 0 0 0 5 9c-4 0-5 3-5 4 0 .667.333 1 1 1h4.216A2.238 2.238 0 0 1 5 13c0-1.01.377-2.042 1.09-2.904.243-.294.526-.569.846-.816ZM4.92 10A5.493 5.493 0 0 0 4 13H1c0-.26.164-1.03.76-1.724.545-.636 1.492-1.256 3.16-1.275ZM1.5 5.5a3 3 0 1 1 6 0 3 3 0 0 1-6 0Zm3-2a2 2 0 1 0 0 4 2 2 0 0 0 0-4Z" />
                                                       </svg>{/if}
                                                       {if $gcl_key == 'admin'} <svg xmlns="http://www.w3.org/2000/svg"
                                                       ...
                                                       {if $gcl_key == 'training'} <svg xmlns="http://www.w3.org/2000/svg"
                                                       ...
                                                       {if $gcl_key == 'about'} <svg xmlns="http://www.w3.org/2000/svg"
                                                                 width="16" height="16" fill="currentColor"
                                                       ...
                                                       <a id="{$gcl_key}_link" href="{$GCL.URL}" {if !empty($GCL.ONCLICK)}
                                                                 onclick="{$GCL.ONCLICK}" {/if} {if !empty($GCL.TARGET)}
                                                            target="{$GCL.TARGET}" {/if}>{$GCL.LABEL}</a>
                                                  </li>
                                             {/foreach}
                                             <li class="box-item">
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                  ...
                                                  <a role="menuitem" id="logout_link"
                                                       href='{$LOGOUT_LINK}'>{$LOGOUT_LABEL}</a>
                                             </li>
                                        </ul>
                                   </li>
                              </ul>
                              ...
                              <button
                                   class="menu-mobile-icon navbar-toggler navbar-toggler-right d-lg-none align-self-center"
                                        ...
                                        {if $item.module_name != 'Emails' && $item.module_name != 'InboundEmail' && $item.module_name != 'EmailAddresses'}
                                             ...
                                             {if $smarty.foreach.lastViewed.index < 10}
                                                  <li class="view-recent__item">
                                                       <a class="d-flex gap-1 align-items-center cursor-pointer"
                                                            title="{sugar_translate module=$item.module_name label=LBL_MODULE_NAME}"
                                                            accessKey="{$smarty.foreach.lastViewed.iteration}"
                                                            href="{sugar_link module=$item.module_name action='DetailView' record=$item.item_id link_only=1}"
                                                            class="view-recent__link">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                         ...
                         <ul class="list-menu-horizontal-mobile sidebar-nav" id="sidebar-nav">
                              ...
                              {if $USE_GROUP_TABS}
                                   ...
                                   {foreach from=$groupTabs item=modules key=group name=groupList}
                                        ...
                                        {if not $smarty.foreach.groupList.last}
                                             <li class="nav-item">
                                                  <a href="#grouptab_{$smarty.foreach.groupList.index}_{$smarty.foreach.groupList.index}"
                                                       class="nav-link collapsed" data-bs-toggle="collapse"
                                                       aria-controls="grouptab_{$smarty.foreach.groupList.index}_{$smarty.foreach.groupList.index}">
                                                       {if $group == 'Hỗ trợ' || $group == 'Support'}
                                                       ...
                                                       {elseif $group == 'Bán hàng' || $group == 'Sales'}
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                                 class="bi bi-basket3 menu-icon" viewBox="0 0 16 16">
                                                                 <path
                                                                      d="M5.757 1.071a.5.5 0 0 1 .172.686L3.383 6h9.234L10.07 1.757a.5.5 0 1 1 .858-.514L13.783 6H15.5a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H.5a.5.5 0 0 1-.5-.5v-1A.5.5 0 0 1 .5 6h1.717L5.07 1.243a.5.5 0 0 1 .686-.172zM3.394 15l-1.48-6h-.97l1.525 6.426a.75.75 0 0 0 .729.574h9.606a.75.75 0 0 0 .73-.574L15.056 9h-.972l-1.479 6h-9.21z" />
                                                            </svg>
                                                       {elseif $group == 'Quản lý' || $group == 'Marketing'}
                                                       ...
                                                       <span class="group_name menu-title me-2">{$group}</span>
                                                       <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                            class="bi bi-chevron-down menu-arrow me-0" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd"
                                                                 d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                                       </svg>
                                                  </a>
                                                  <ul class="sidebar-nav sub-menu nav-content collapse box-list"
                                                       id="grouptab_{$smarty.foreach.groupList.index}_{$smarty.foreach.groupList.index}">
                         ...
                         {foreach from=$moduleTopMenu item=module key=name name=moduleList}
                              ...
                              {if $name == $MODULE_TAB}
                                   <li class="nav-item nav-current-item">
                                        <a href="{sugar_link id=" moduleTab_$name" link_only=1 module=$name data=$module class="active_module_link" }"
                                             data-module="{$module}" class="nav-link nav-link-current">
                                             {if $name == 'EC_Vouchers'}
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                       ...
                                                       <path
                                                            d="M1 7.086V2a1 1 0 0 1 1-1v5.086a1 1 0 0 0 .293.707l7 7L8.586 14.5l-7-7A1 1 0 0 1 1 7.086Z" />
                                                  </svg>
                                             {else}
                                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                                                                ...
                                                                                <a class="nav-link" href="{$item.URL}">
                                                                                     ...
                                                                                     {elseif strstr($item.LABEL|lower, 'phát hành voucher') || strstr($item.LABEL|lower, 'phat hanh voucher')}
                                                                                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                                               ...
                                                                                               viewBox="0 0 16 16">
                                                                                               <path
                                                                                                    d="M4 4.85v.9h1v-.9H4Zm7 0v.9h1v-.9h-1ZM4 7.1V8h1v-.9H4Zm7 0V8h1v-.9h-1ZM4 9.35v.9h1v-.9H4Zm7 0v.9h1v-.9h-1Z" />
                                                                                               <path
                                                                                                    d="M1.5 3A1.5 1.5 0 0 0 0 4.5V6a.5.5 0 0 0 .5.5 1.5 1.5 0 1 1 0 3 .5.5 0 0 0-.5.5v1.5A1.5 1.5 0 0 0 1.5 13h13a1.5 1.5 0 0 0 1.5-1.5V10a.5.5 0 0 0-.5-.5 1.5 1.5 0 0 1 0-3A.5.5 0 0 0 16 6V4.5A1.5 1.5 0 0 0 14.5 3h-13ZM1 4.5a.5.5 0 0 1 .5-.5h13a.5.5 0 0 1 .5.5v1.05a2.5 2.5 0 0 0 0 4.9v1.05a.5.5 0 0 1-.5.5h-13a.5.5 0 0 1-.5-.5v-1.05a2.5 2.5 0 0 0 0-4.9V4.5Z" />
                                                                                               <path
                                                                                                    d="M7.5 4.5a.5.5 0 0 1 1 0V7H11a.5.5 0 0 1 0 1H8.5v2.5a.5.5 0 0 1-1 0V8H5a.5.5 0 0 1 0-1h2.5V4.5Z" />
                                                                                          </svg>
                                                                                     ...
                                                                                     {elseif strstr($item.LABEL|lower, 'd/s') || strstr($item.LABEL|lower, 'danh sách')}
                                                                                          <svg width="16px" height="16px" stroke-width="2.1" viewBox="0 0 24 24"
                                                                                               fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000">
                                                                                               <path d="M8 6L20 6" stroke="#000000" stroke-width="2.1"
                                                                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                                                                               <path d="M4 6.01L4.01 5.99889" stroke="#000000" stroke-width="2.1"
                                                                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                                                                               <path d="M4 12.01L4.01 11.9989" stroke="#000000" stroke-width="2.1"
                                                                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                                                                               <path d="M4 18.01L4.01 17.9989" stroke="#000000" stroke-width="2.1"
                                                                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                                                                               <path d="M8 12L20 12" stroke="#000000" stroke-width="2.1"
                                                                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                                                                               <path d="M8 18L20 18" stroke="#000000" stroke-width="2.1"
                                                                                                    stroke-linecap="round" stroke-linejoin="round"></path>
                                                                                          </svg>
                                                                                     ...
                                                                                     {elseif strstr($item.LABEL|lower, 'sim')}
                                                                                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                                                               fill="currentColor" class="bi bi-sim" viewBox="0 0 16 16">
                                                                                               <path
                                                                                     ...
                                                                                     {elseif strstr($item.LABEL|lower, 'xuất vé')}
                                                                                          <svg fill="#000000" height="18px" width="18px" version="1.1" id="Layer_1"
                                                                                               xmlns="http://www.w3.org/2000/svg"
                                                                                               xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512.16 512.16"
                                                                                               xml:space="preserve">
                                                                                     ...
                                                                                     {elseif strstr($item.LABEL|lower, 'tcb')}
                                                                                          <svg fill="currentColor" height="18" width="18" version="1.1" id="Layer_1"
                                                                                               xmlns="http://www.w3.org/2000/svg"
                                                                                               xmlns:xlink="http://www.w3.org/1999/xlink"
                                                                                               ...
                                                                                               <g id="SVGRepo_iconCarrier">
                                                                                                    <g>
                                                                                                         <path
                                                                                                              d="M262.797,274.552c30.206,30.206,63.252,49.446,81.428,47.771c13.579-1.252,30.7-19.862,30.7-19.862l-38.945-38.944 l-15.532,15.532L258.3,216.901l15.532-15.532l-38.945-38.944c0,0-18.611,17.12-19.862,30.699 C213.351,211.3,232.59,244.345,262.797,274.552z">
                                                                                                         </path>
                                                                                                         <path
                                                                                                              d="M49.924,0v113.712h-22.5v30h22.5v83.712h-25v30h25v83.712h-25v30h25v113.712h410V0H49.924z M79.924,371.136h25v-30h-25 v-83.712h25v-30h-25v-83.712h25v-30h-25V30h50v424.849h-50V371.136z M429.924,454.849h-270V30h270V454.849z">
                                                                                                         </path>
                                                                                                    </g>
                                                                                               </g>
                                                                                          </svg>
                                                                                     ...
                                                                                     {elseif strstr($item.LABEL|lower, 'bxh')}
                                                                                          <svg width="18" height="18" viewBox="0 0 48 48" fill="none"
                                                                                               ...
                                                                                               <g id="SVGRepo_iconCarrier">
                                                                                                    ...
                                                                                                    <rect x="4" y="18" width="13" height="24" stroke="currentColor"
                                                                                                         fill="#fff" stroke-width="4" stroke-linecap="round"
                                                                                                         stroke-linejoin="round"></rect>
                                                                                                    <rect x="17" y="6" width="13" height="36" stroke="currentColor"
                                                                                                         fill="#fff" stroke-width="4" stroke-linejoin="round"></rect>
                                                                                                    <rect x="30" y="26" width="13" height="16" stroke="currentColor"
                                                                                                         fill="#fff" stroke-width="4" stroke-linecap="round"
                                                                                                         stroke-linejoin="round"></rect>
                                                                                               </g>
                                                                                          </svg>
