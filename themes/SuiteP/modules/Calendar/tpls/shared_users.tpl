	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
				...
				<div class="container-fluid">
					<div class="panel panel-default ">
						<div class="panel-heading  panel-heading-collapse">
							<a id="subpanel_title_activities" role="button" data-bs-toggle="collapse" href="#subpanel_settings_user_list">
						...
						<div id="subpanel_settings_user_list" class="panel-body panel-collapse collapse show">
			...
			<div class="modal-footer">
				<button id="sharedCalUsersSelectBtn" data-bs-dismiss="modal" class="btn btn-default" type="button">{$MOD.LBL_CANCEL_BUTTON}</button>
