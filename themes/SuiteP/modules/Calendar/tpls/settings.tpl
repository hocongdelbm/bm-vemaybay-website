	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
					...
					<form name="settings" id="form_settings" method="POST" action="index.php?module=Calendar&action=SaveSettings">
						...
						<div class="panel panel-default ">
							 <div class="panel-heading  panel-heading-collapse">
								<a id="subpanel_title_activities" class="" role="button" data-bs-toggle="collapse" href="#subpanel_settings_settings">
									{$MOD.LBL_SETTINGS_TITLE}
								</a>
							</div>
							<div id="subpanel_settings_settings" class="panel-body panel-collapse collapse show">
						...
						<div class="panel panel-default ">
							<div class="panel-heading panel-heading-collapse">
								<a id="subpanel_title_activities" class="" role="button" data-bs-toggle="collapse" href="#subpanel_settings_color">
									{$MOD.LBL_COLOR_SETTINGS}
								</a>
							</div>
							<div id="subpanel_settings_color" class="panel-body panel-collapse collapse show">
								<table class="table-responsive">
									<tr>
			...
			<div class="modal-footer">
				<button data-bs-dismiss="modal" class="btn btn-default" type="button">{$MOD.LBL_CANCEL_BUTTON}</button>
