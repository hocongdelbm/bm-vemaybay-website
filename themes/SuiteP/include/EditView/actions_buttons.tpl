<div class="buttons buttons-editview d-flex gap-2 position-relative">
    ...
    {{/if}}
    {if $showVCRControl}
            <button type="button" id="save_and_continue" class="btn btn-primary saveAndContinue" title="{$app_strings.LBL_SAVE_AND_CONTINUE}" onClick="SUGAR.saveAndContinue(this);">
