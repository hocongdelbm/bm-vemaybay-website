...
class SugarWidgetSubPanelTopCreateLeadNameButton extends SugarWidgetSubPanelTopButtonQuickCreate
{
    ...
    public function display($defines, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        if (ACLController::moduleSupportsACL($defines['module'])  && !ACLController::checkAccess($defines['module'], 'edit', true)) {
            $button = "<input title='$title'class='btn btn-disabled' type='button' name='button' value='  $value  ' disabled/>\n";
            return $button;
        }
        ...
        $button .= "<input title='$title' class='btn btn-primary' type='submit' name='{$this->getWidgetId()}_button' id='{$this->getWidgetId()}' value='  $value  '/>\n";
        $button .= "</form>";
        return $button;
    }
}
