...
class SugarWidgetSubPanelManageDelegatesButton extends SugarWidgetSubPanelTopButton
{
    public function display($defines, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        $button .= "<input id='Manage_Delegates' class='btn btn-primary' type='button' name='Manage_Delegates' onclick='manage_delegates()' value='".$mod_strings['LBL_MANAGE_DELEGATES']."'/>\n</form>";
        return $button;
    }
}
