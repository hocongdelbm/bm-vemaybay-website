...
class SugarWidgetSubPanelManageAcceptancesButton extends SugarWidgetSubPanelTopButton
{
    public function display($defines, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        $button .= "<input id='Manage_Acceptances' class='btn btn-primary' type='button' name='Manage_Acceptances' onclick='manage_acceptances();' value='".$mod_strings['LBL_MANAGE_ACCEPTANCES']."'/>\n</form>";
        return $button;
    }
}
