    ...
    */
    ...
    public function display($defines, $additionalFormFields = null, $nonbutton = false)
    {
        ...
        if (isset($_REQUEST['layout_def_key']) && $_REQUEST['layout_def_key'] == 'UserEAPM') {
            ...
            $button = "<input title='$this->title' accesskey='$this->access_key' class='btn btn-primary' type='submit' name='$inputID' id='$inputID' value='$this->form_value' onclick='javascript:document.location=\"index.php?".$megaLink."\"; return false;'/>";
        } else {
            $button = $this->_get_form($defines, $additionalFormFields);
            $button .= "<input title='$this->title' accesskey='$this->access_key' class='btn btn-primary' type='submit' name='$inputID' id='$inputID' value='$this->form_value' />\n</form>";
        }
