...
<fieldset id='{{$key}}_address_fieldset'>
    ...
    <table border="0" cellspacing="1" cellpadding="0" class="table-edit table-editview-vn__Address-in-theme" width="100%">
        <tr>
        ...
        <tr>
            <td scope='row' NOWRAP>
                <label>{sugar_translate label='LBL_COPY_ADDRESS_FROM_LEFT' module=''}:</label>
            </td>
            <td>
