...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="formHeader h3Row form_header--theme">
    <tr>
        <td nowrap>
            <h4 class="dialog-title">{$form_title}</h4>
        </td>

        {assign var=keywords expr="array('class=\"btn btn-primary\"', 'class=\"btn btn-primary\"', 'class=btn btn-primary', '</form>')" value="array('class=\"btn btn-primary\"', 'class=\"btn btn-primary\"', 'class=btn btn-primary', '</form>')"}
