...
class Popup_Picker
{
    ...
    public function process_page()
    {
        ...
        if ($this->_create) {
			...
			<input type="submit" name="button" class="btn btn-primary" title="$lbl_save_button_title" value="  $lbl_save_button_label  " />
			<input type="button" name="button" class="btn btn-danger" title="{$app_strings['LBL_CANCEL_BUTTON_TITLE']}" accesskey="{$app_strings['LBL_CANCEL_BUTTON_KEY']}" value="{$app_strings['LBL_CANCEL_BUTTON_LABEL']}" onclick="toggleDisplay('addform');" />
EOQ;
            ...
            $createButton = <<<EOQ
			<input type="button" id="showAdd" name="showAdd" class="btn btn-primary" value="{$createButtonTranslation}" onclick="toggleDisplay('addform');" />
EOQ;
