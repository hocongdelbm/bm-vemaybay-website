...
eoq;
    ...
    public function getMassUpdateForm(
        ...
        $html .= "<div id='mass_update_div'><table cellpadding='0' cellspacing='1' border='0' width='100%' class='table-edit table-mass-update__in-themes' id='mass_update_table'>";
...
EOHTML;
    ...
    public function addAssignedUserID($displayname, $varname)
    {
		...
		<span class="id-ff multiple"><button id="mass_assigned_user_name_btn" title="{$app_strings['LBL_SELECT_BUTTON_TITLE']}" type="button" class="btn btn-primary" value='{$app_strings['LBL_SELECT_BUTTON_LABEL']}' name=btn1
