        ...
        if (typeof columnsFilter == 'undefined') {
            ...
            var columnsFilter = {
                ...
                getDragDropChooserHTML: function (chooserData) {
                    ...
                    $('#chooserTemplate .chooserList.hidden-list').html('');
                    $.each(chooserData.args.values_array[1], function (key, value) {
                        $('#chooserTemplate .chooserList.hidden-list').append('<li data-key="' + key + '">' + value + '</li>');
                    });
                ...
                initDragDropChooser: function () {
                    ...
                    $("#columnsFilterList .chooserContent .chooserList.green").sortable({
                        connectWith: "#columnsFilterList .chooserContent .chooserList.hidden-list",
                        stop: function () {
                            _this.isValid();
                        }
                    });
                    ...
                    $("#columnsFilterList .chooserContent .chooserList.hidden-list").sortable({
                        connectWith: "#columnsFilterList .chooserContent .chooserList.green",
                        stop: function () {
                            _this.isValid();
                        }
                    });
                    $("#columnsFilterList .chooserContent .chooserList.hidden-list").disableSelection();
