...
function smarty_function_sugar_help($params, &$smarty)
{
    ...
    // return <<<EOHTML
    //     <img border="0" onclick="$click" src="$helpImage" alt="$alt_tag" class="inlineHelpTip" />
    // EOHTML;
    return <<<EOHTML
        <svg onclick="$click"  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="inlineHelpTip bi bi-question-circle" viewBox="0 0 16 16">
