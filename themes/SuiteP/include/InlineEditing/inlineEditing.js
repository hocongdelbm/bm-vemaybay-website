    ...
    var onInlineEditDblClick = function(elem, e) {
        ...
        if (field && id && module) {
            ...
            if (html) {
                $(_this).html(
                    validation +
                        "<form name='EditView' id='EditView' class='d-flex align-items-center gap-2'><div id='inline_edit_field'>" +
                        html +
                        "</div><a id='inlineEditSaveButton' class='d-flex align-items-center'></a></form>"
                );
