...
// Credentials are generated by Chat when the webhook is registered and are
// provisioned to BM through environment variables. They must never be
...
$getEnvironmentValue = static function ($name) {
    $value = getenv($name);
