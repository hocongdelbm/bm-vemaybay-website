...
class ProcessRecordLogicHook
{
    public function custom_column(SugarBean $bean, $event, $arguments)
    {
        ...
        $call_from_phone = ($bean->direction == 'outbound' && strlen($bean->call_from) < 12) ? (!empty($other_caller) ? $other_caller : $bean->call_from) : $bean->call_from;
        ...
        $call_from = '<div class="phone-dropdown dropdown flex-between">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-item flex-start cursor-pointer copy-phone" onclick="copyContent(\'' . $call_from_phone . '\');">
                            ...
                            <li class="dropdown-item flex-start cursor-pointer btn-voiceip-calling' . $call_from_zalo . '" id="listview-call_from" phone="' . $call_from_phone . '">
