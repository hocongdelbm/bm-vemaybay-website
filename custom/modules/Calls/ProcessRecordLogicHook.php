    ...
    public function custom_column(SugarBean $bean, $event, $arguments) {
        ...
        $call_from = '<div class="phone-dropdown dropdown flex-between">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-item flex-start cursor-pointer copy-phone" onclick="copyContent(\''.$bean->call_from.'\');">
                            ...
                            <li class="dropdown-item flex-start cursor-pointer btn-voiceip-calling'.$call_from_zalo.'" id="listview-call_from" phone="'.$bean->call_from.'">
