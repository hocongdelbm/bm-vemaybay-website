...
class SugarTheme
{
    ...
    public function getCSS($color = null, $font = null ) {
        ...
        $html = '<link rel="stylesheet" type="text/css" href="include/javascript/qtip/jquery.qtip.min.css" />';
        $html .= '<link rel="stylesheet" type="text/css" href="'.$this->getCSSURL('yui.css').'" />';
        $html .= '<link rel="stylesheet" type="text/css" href="themes/SuiteP/libs/css/jquery-ui.min.css" />';
        ...
        $html .= '<link rel="stylesheet" type="text/css"href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" />';
    ...
    public function getJS()
    {
        ...
        // Fix .live() is not a function
        // Made by DucPham - 19/04/2023
        $fix_js = '<script>
            jQuery.fn.extend({
