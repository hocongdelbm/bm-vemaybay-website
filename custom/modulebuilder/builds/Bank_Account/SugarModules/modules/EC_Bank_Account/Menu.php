...
if(ACLController::checkAccess('EC_Bank_Account', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_Bank_Account&return_module=EC_Bank_Account&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_Bank_Account');
}