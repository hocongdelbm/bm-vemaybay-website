...
if(ACLController::checkAccess('EC_TaiKhoan', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_TaiKhoan&return_module=EC_TaiKhoan&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_TaiKhoan');
}