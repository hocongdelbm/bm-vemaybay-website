...
if(ACLController::checkAccess('EC_Request_Flight', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_Request_Flight&return_module=EC_Request_Flight&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_Request_Flight');
}