...
if(ACLController::checkAccess('EC_NhomTaiKhoan', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_NhomTaiKhoan&return_module=EC_NhomTaiKhoan&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_NhomTaiKhoan');
}