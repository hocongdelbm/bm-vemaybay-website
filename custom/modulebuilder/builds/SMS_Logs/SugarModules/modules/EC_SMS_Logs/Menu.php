...
if (ACLController::checkAccess('EC_SMS_Logs', 'import', true)) {
    $module_menu[] = array('index.php?module=Import&action=Step1&import_module=EC_SMS_Logs&return_module=EC_SMS_Logs&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_SMS_Logs');
}
