...
if(ACLController::checkAccess('EC_LoaiChungTu', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_LoaiChungTu&return_module=EC_LoaiChungTu&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_LoaiChungTu');
}