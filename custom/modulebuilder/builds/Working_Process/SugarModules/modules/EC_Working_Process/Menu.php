...
if(ACLController::checkAccess('EC_Working_Process', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_Working_Process&return_module=EC_Working_Process&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_Working_Process');
}