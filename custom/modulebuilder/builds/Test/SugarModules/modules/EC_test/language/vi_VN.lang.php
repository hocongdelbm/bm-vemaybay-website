...
$mod_strings = array (
  ...
  'LBL_LIST_FORM_TITLE' => 'test Danh sách',
  'LBL_MODULE_NAME' => 'test',
  'LBL_MODULE_TITLE' => 'test',
  'LBL_HOMEPAGE_TITLE' => 'Của tôi test',
  'LNK_NEW_RECORD' => 'Tạo test',
  'LNK_LIST' => 'Xem test',
  'LNK_IMPORT_EC_TEST' => 'Nhập test',
  'LBL_SEARCH_FORM_TITLE' => 'Tìm kiếm test',
  'LBL_HISTORY_SUBPANEL_TITLE' => 'Xem lịch sử',
  'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Hoạt động',
  'LBL_EC_TEST_SUBPANEL_TITLE' => 'test',
  'LBL_NEW_FORM_TITLE' => 'Mới test',
);