...
if (ACLController::checkAccess('EC_Booking_Itineraries', 'import', true)) {
    $module_menu[] = array('index.php?module=Import&action=Step1&import_module=EC_Booking_Itineraries&return_module=EC_Booking_Itineraries&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_Booking_Itineraries');
}
