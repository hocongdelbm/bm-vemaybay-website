...
if(ACLController::checkAccess('EC_Payment_Types', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_Payment_Types&return_module=EC_Payment_Types&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_Payment_Types');
}