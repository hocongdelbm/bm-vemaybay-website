...
if(ACLController::checkAccess('EC_ChuyenTienNoiBo', 'import', true)){
    $module_menu[]=array('index.php?module=Import&action=Step1&import_module=EC_ChuyenTienNoiBo&return_module=EC_ChuyenTienNoiBo&return_action=index', $app_strings['LBL_IMPORT'], 'Import', 'EC_ChuyenTienNoiBo');
}