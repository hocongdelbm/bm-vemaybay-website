...
$app_strings = array(
    ...
    'LBL_LOGOUT_SUCCESS' => 'Đăng nhập thành công',
    ...
    'NTC_OVERWRITE_ADDRESS_PHONE_CONFIRM' => 'Dữ liệu này hiện đang có giá trị trong các lĩnh vực văn phòng điện thoại và địa chỉ. Để ghi đè lên các giá trị này với các văn phòng điện thoại và địa chỉ của tài khoản mà bạn đã chọn, nhấn "OK". Để giữ cho các giá trị hiện tại, nhấp vào "Hủy bỏ".',
    ...
    'ERR_UNAUTHORIZED_PAGE_ACCESS' => 'Bạn không được phép xem trang này. Vui lòng liên hệ với quản trị viên hệ thống của bạn.',
    'ERR_UNAUTHORIZED_PAGE_ACCESS_TO_HOME_PAGE' => 'Bạn không được phép xem trang này. Chuyển hướng đến Trang chủ...',
    'ERR_MISSING_REQUIRED_FIELDS' => 'Required:',
    ...
    'LBL_MASS_DUPLICATE_UPDATE' => 'Duplicate & Mass Update', // SuiteCRM PR 9877
    ...
    'LBL_AND' => '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dash-lg" viewBox="0 0 16 16"><path fill-rule="evenodd" d="M2 8a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11A.5.5 0 0 1 2 8Z"/></svg>',
    ...
    'LBL_BULK_ACTION_BUTTON_LABEL' => 'Thao tác',
    'LBL_BULK_ACTION_BUTTON_LABEL_MOBILE' => 'Thao tác',
    'LBL_TOO_FEW_SELECTED' => 'Bản ghi được chọn có giá trị không hợp lệ. Bạn phải chọn một giá trị tối thiểu của bản ghi {min}.',
    'LBL_TOO_MANY_SELECTED' => 'Bản ghi được chọn có giá trị không hợp lệ. Bạn phải chọn một giá trị tối đa của bản ghi {max}.',
    'LBL_SELECT_ALL_NOT_ALLOWED' => 'Việc chọn tất cả các bản ghi sẽ không có sẵn cho hành động này. Vui lòng chọn từng bản ghi.',
    'LBL_MISSING_HANDLER_DATA' => 'Lỗi hệ thống không dự đoán. Thiếu dữ liệu xử lý hàng loạt từ thông tin phản hồi',
    'LBL_MISSING_HANDLER' => 'Lỗi hệ thống không dự đoán. Không có tệp dữ liệu được chọn để xử lý',
    'LBL_MISSING_HANDLER_DATA_ROUTE' => 'Lỗi không mong muốn. Thiếu tuyến đường hành động hàng loạt',
    'LBL_ACTION_ERROR' => 'Lỗi không mong muốn khi gọi hành động',
    'LBL_BULK_ACTION_ERROR' => 'Lỗi không mong muốn khi gọi Hành động hàng loạt',
    'LBL_BULK_ACTION_DELETE_SUCCESS' => '(Các) bản ghi đã bị xóa thành công',
    'LBL_BULK_ACTION_MASS_UPDATE_CONFIRMATION' => 'Bạn có chắc chắn muốn cập nhật (các) bản ghi đã chọn không?',
    'LBL_BULK_ACTION_MASS_UPDATE_SUCCESS' => 'Tất cả (các) bản ghi được cập nhật thành công',
    'LBL_BULK_ACTION_MASS_UPDATE_PARTIAL_SUCCESS' => 'Thành công một phần. Một số hồ sơ không được cập nhật. vui lòng kiểm tra nhật ký',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_FIELDS' => 'Không có trường nào để cập nhật',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_RECORDS' => 'Không có bản ghi nào để cập nhật',
    'LBL_BULK_ACTION_MASS_UPDATE_NO_ACLS' => 'Không đủ đặc quyền, lưu hành động không được phép',
    'LBL_UNEXPECTED_ERROR' => 'Lỗi không mong muốn. Không thể thực hiện hành động.',
    'LBL_RECORD_DELETE_SUCCESS' => 'Bản ghi được xóa thành công',
    'LBL_RECORD_DELETE_ALL_SUCCESS' => 'Records deleted successfully',
    'LBL_RECORD_SNOOZE_SUCCESS' => 'Notification Snoozed',
    'LBL_ERROR_SAVING' => 'Đã xảy ra lỗi khi lưu bản ghi',
    ...
    'LBL_COLUMN_SELECTOR_MODAL_TITLE' => 'Chọn cột',
);
...
$app_list_strings['moduleList']['AOP_Case_Events'] = 'Các Sự kiện của Vụ việc';
$app_list_strings['moduleList']['AOP_Case_Updates'] = 'Cập nhật Vụ việc';
...
$app_list_strings['marker_image_list']['sun'] = 'C.N';
...
$app_strings['LBL_INSIGHTS'] = 'Thông tin chi tiết';
$app_strings['LBL_CHARTS'] = 'Biểu đồ';
$app_strings['LBL_CHART_NOT_FOUND'] = 'Không tìm thấy biểu đồ';
$app_strings['LBL_NO_DATA'] = 'Không có dữ liệu';
$app_strings['LBL_ERROR_FETCHING_METADATA'] = 'Đã xảy ra lỗi khi tìm nạp siêu dữ liệu';
$app_strings['LBL_TOTAL'] = 'Tổng cộng';
$app_strings['LBL_ACTIONS'] = 'Hành động';
$app_strings['LBL_SELECT_SUBPANEL_BANNER'] = 'Chọn bảng con để xem';
$app_strings['LBL_SELECT_ITEM'] = 'Chọn một mục';
$app_strings['LBL_WIDGET_NOT_FOUND'] = 'Không tìm thấy Widget';
$app_strings['LBL_BAD_CONFIG'] = 'Cấu hình không chính xác';
$app_strings['LBL_CONFIG_BAD_CONTEXT'] = 'Cấu hình không chính xác: ngữ cảnh không được định cấu hình đúng cách';
$app_strings['LBL_CONFIG_NO_CONFIG'] = 'Cấu hình không chính xác: thiếu cấu hình';
$app_strings['LBL_CONFIG_NO_STATISTICS_KEY'] = 'Cấu hình không chính xác: thiếu khóa thống kê';
$app_strings['LBL_STATISTIC_ERROR'] = 'Lỗi khi tải thống kê';
$app_strings['LBL_STATISTIC_ERROR_DESC'] = 'Lỗi khi tải thống kê';
$app_strings['LBL_STATISTIC_ERROR_DESC_TOOLTIP'] = 'Lỗi khi tải thống kê. Vui lòng liên hệ với quản trị viên của bạn';
$app_strings['LBL_AVERAGE_CLOSED_WON_PER_YEAR'] = 'Cơ hội giành được trung bình mỗi năm';
$app_strings['LBL_OPPORTUNITIES_TOTAL'] = 'Tổng giá trị cơ hội';
$app_strings['LBL_CASE_TOTAL_DAYS_OPEN'] = 'Tổng số ngày mở cửa';
$app_strings['LBL_DAYS_OPEN'] = 'Ngày mở cửa';
$app_strings['LBL_DAYS_IN_SALE_STAGE'] = 'Cơ hội này đã ở trong giai đoạn bán hàng này cho';
$app_strings['LBL_STAT_DAYS'] = 'Ngày(s)';
$app_strings['LBL_CLOSED_PER_YEAR'] = 'Đóng cửa mỗi năm';
$app_strings['LBL_WAS_OPEN'] = 'Vụ việc này đã được mở cho';
$app_strings['LBL_HAS_BEEN_OPEN'] = 'Vụ việc này đã được mở cho';
$app_strings['LBL_NUMBER_OF_CASES_PER_ACCOUNT'] = 'Tổng số Vụ việc của một Khách hàng';
$app_strings['LBL_TOTAL_CASES_FOR_THIS_ACCOUNT'] = 'Tổng số Vụ việc cho Khách hàng này: ';
...
$app_strings['LBL_VALIDATION_ERROR_CURRENCY_FORMAT'] = "Định dạng tiền tệ không hợp lệ. Dự kiến: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_INT_FORMAT'] = "Định dạng số nguyên không hợp lệ. Dự kiến: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_FLOAT_FORMAT'] = "Định dạng số thập phân không hợp lệ. Dự kiến: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATE_FORMAT'] = "Định dạng ngày không hợp lệ. Dự kiến: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_DATETIME_FORMAT'] = "Định dạng ngày giờ không hợp lệ. Dự kiến: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_EMAIL_FORMAT'] = "Định dạng email không hợp lệ.Dự kiến: '{{context.expected}}'";
$app_strings['LBL_VALIDATION_ERROR_PHONE_FORMAT'] = "Định dạng số điện thoại không hợp lệ.";
$app_strings['LBL_VALIDATION_ERROR_MIN'] = "Giá trị không hợp lệ. Giá trị phải lớn hơn hoặc bằng '{{context.min}}'";
$app_strings['LBL_VALIDATION_ERROR_MAX'] = "Giá trị không hợp lệ. Giá trị phải nhỏ hơn hoặc bằng '{{context.max}}'";
$app_strings['LBL_MULTIPLE_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Chỉ có thể đánh dấu một địa chỉ email là chính";
$app_strings['LBL_DUPLICATE_EMAIL_VALIDATION_ERROR'] = "Không cho phép các địa chỉ email trùng lặp";
$app_strings['LBL_NO_PRIMARY_EMAIL_VALIDATION_ERROR'] = "Một địa chỉ email phải được đánh dấu là chính";
$app_strings['LBL_VALIDATION_ERRORS'] = 'Có lỗi xác thực, không thể thực hiện hành động.';
$app_strings['LBL_TYPE_TO_SEARCH'] = 'Nhập để tìm kiếm...';
$app_strings['LBL_SEARCHING'] = 'tìm kiếm...';
$app_strings['LBL_NOT_FOUND'] = 'Không tìm thấy.';
$app_strings['LBL_SEARCH_ERROR'] = 'Lỗi tìm kiếm.';
$app_strings['LBL_FOUND'] = 'Tìm';
$app_strings['LBL_GET_RECORD_LIST_ERROR'] = 'Đã xảy ra lỗi trong khi truy xuất bản ghi';
$app_strings['LBL_NUMBER_OF_RECORDS'] = 'Số lượng bản ghi';
...
$app_strings['LBL_CONTRACT_RENEWAL_TOOLTIP'] = 'Ngày gia hạn hợp đồng tiếp theo';
$app_strings['LBL_INVOICES_OVERDUE_TOOLTIP'] = 'Tổng số hóa đơn quá hạn';
$app_strings['LBL_ACTIVITIES_NEXT_DATE_TOOLTIP'] = 'Ngày tương tác tiếp theo';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED_TOOLTIP'] = 'Ngày nhận được Chiến dịch gần đây nhất';
$app_strings['LBL_OPEN_CASES_COUNT_TOOLTIP'] = 'Tổng số Vụ việc đang mở';
$app_strings['LBL_EVENTS_LAST_DATE_TOOLTIP'] = 'Ngày diễn ra sự kiện gần đây nhất';
$app_strings['LBL_HISTORY_LAST_DATE_TOOLTIP'] = 'Ngày của lần tương tác gần đây nhất';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM_TOOLTIP'] = 'Tổng số cơ hội';
$app_strings['LBL_QUOTES_EXPIRY_TOOLTIP'] = 'Ngày hết hạn báo giá tiếp theo';
$app_strings['LBL_DEFAULT_TOTAL_TOOLTIP'] = 'Tổng số bản ghi';
$app_strings['LBL_CONTRACT_RENEWAL'] = 'Ngày gia hạn';
$app_strings['LBL_INVOICES_OVERDUE'] = 'Tổng quá hạn';
$app_strings['LBL_ACTIVITIES_NEXT_DATE'] = 'Ngày hoạt động tiếp theo';
$app_strings['LBL_CAMPAIGN_LAST_RECEIVED'] = 'Last Participated';
$app_strings['LBL_OPEN_CASES_COUNT'] = 'Vụ việc đang mở';
$app_strings['LBL_EVENTS_LAST_DATE'] = 'Sự kiện cuối cùng đã tham dự';
$app_strings['LBL_HISTORY_LAST_DATE'] = 'Điểm tiếp xúc cuối cùng';
$app_strings['LBL_OPPORTUNITIES_TOTAL_SUM'] = 'Tổng giá trị';
$app_strings['LBL_QUOTES_EXPIRY'] = 'Ngày hết hạn tiếp theo';
...
$app_strings['LBL_CASE_UPDATES'] = 'Cập nhật Vụ việc';
$app_strings['LBL_CASE_UPDATE_SUBMITTED'] = 'Cập nhật Vụ việc đã được gửi';
...
$app_strings['LBL_SAVED_FILTER_SAVED'] = 'Bộ lọc đã được lưu thành công';
$app_strings['LBL_FILTER_ID_NOT_DEFINED'] = 'Id bộ lọc chưa được xác định';
$app_strings['LBL_GENERIC_CONFIRMATION'] = 'Bạn có muốn tiếp tục hành động không?';
$app_strings['LBL_SHOW_MORE'] = 'Xem thêm';
$app_strings['LBL_SHOW_LESS'] = 'Hiển thị ít hơn';
$app_strings['LBL_LOAD_MORE'] = 'Tải thêm';
$app_strings['LBL_EMPTY'] = '--Trống-- ';
$app_strings['LBL_OPERATOR'] = 'Toán tử';
$app_strings['LBL_START'] = 'bắt đầu';
$app_strings['LBL_END'] = 'Kết thúc';
$app_strings['LBL_LINE_ITEMS_FIELD_CONFIG'] = 'Cấu hình tệ';


$app_strings['LBL_ACTION_SUCCESS'] = 'Hành động thành công';
...
$app_strings['LBL_UNLINK_RECORD'] = 'Hủy liên kết bản ghi';
$app_strings['LBL_EDIT_RECORD'] = 'Sửa bản ghi';
$app_strings['LBL_UNLINK_RELATIONSHIP_CONFIRM'] = 'Bạn có chắc chắn muốn hủy liên kết bản ghi này không? Chỉ mối quan hệ sẽ bị hủy liên kết. Bản ghi sẽ không bị xóa.';
$app_strings['LBL_UNLINK_RELATIONSHIP_SUCCESS'] = 'Đã hủy liên kết bản ghi thành công.';
$app_strings['LBL_UNLINK_RELATIONSHIP_FAILED'] = 'There was an error unlinking this record.';
$app_strings['LBL_LINK_RELATIONSHIP_SUCCESS'] = 'Đã liên kết thành công mối quan hệ.';
$app_strings['LBL_LINK_RELATIONSHIP_FAILED'] = 'Đã xảy ra lỗi liên kết Mối quan hệ này.';
$app_strings['LBL_MODULE_NOT_FOUND'] = 'Không tìm thấy mô-đun.';
$app_strings['LBL_RECORD_NOT_FOUND'] = 'Không thể tải bản ghi';
$app_strings['LBL_RELATIONSHIP_LOAD_ERROR'] = 'Không thể tải mối quan hệ';
$app_strings['LBL_NOT_LINKED'] = 'Không thể hủy liên kết. Các bản ghi không được nối kết';
$app_strings['LBL_ACCESS_DENIED'] = 'Truy cập bị từ chối';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_SUCCESS'] = 'Đã thêm bản ghi vào danh sách mục tiêu thành công.';
$app_strings['LBL_ADD_RECORDS_TO_TARGET_LIST_FAILED'] = 'Đã xảy ra lỗi khi thêm bản ghi vào danh sách mục tiêu.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_SUCCESS'] = 'Liên hệ được thêm vào danh sách mục tiêu thành công.';
$app_strings['LBL_ADD_CONTACTS_TO_TARGET_LIST_FAILED'] = 'Đã xảy ra lỗi khi thêm liên hệ vào danh sách mục tiêu.';
$app_strings['LBL_CHANGED_TO_TEXT'] = 'đã thay đổi thành';
$app_strings['LBL_RECORD_CHANGED'] = 'Đã cập nhật bản ghi';
$app_strings['LBL_CREATE'] = "Tạo";
$app_strings['LBL_USE_ADVANCED_SEARCH'] = 'Sử dụng Tìm kiếm nâng cao';
$app_strings['LBL_USE_BASIC_SEARCH'] = 'Sử dụng Tìm kiếm Cơ bản';
$app_strings['LBL_NO_MODULE_SELECTED'] = 'Không có mô-đun nào được chọn';
$app_strings['LBL_CLOSE_MENU'] = 'Đóng Menu';
$app_strings['LOGIN_INCORRECT'] = 'Thông tin đăng nhập không chính xác, vui lòng thử lại.';
$app_strings['LOGIN_TOO_MANY_FAILED'] = 'Quá nhiều lần đăng nhập không thành công, vui lòng thử lại sau.';

// PDF Engines
$app_strings['LBL_LEGACY_MPDF_ENGINE'] = 'Công cụ MPDF kế thừa';
$app_strings['LBL_TCPDF_ENGINE'] = 'Công cụ TCPDF';


$app_strings['ERR_INVALID_FILE_NAME'] = 'Tên tệp không hợp lệ:';
$app_strings['LBL_LOGGER_VALID_FILENAME_CHARACTERS'] = 'Đây chỉ có thể là các ký tự chữ và số, cộng với \'.\' , \'-\' và \'_\'';
$app_strings['LBL_LOGGER_INVALID_FILENAME'] = 'Tên tệp nhập không hợp lệ';
...
$app_strings['LBL_SIGNATURE'] = 'Chữ ký';
