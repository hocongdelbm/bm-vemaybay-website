...
<div class="row gap-2">
	<div class="col-xs-12 col-md-12 email-address-add-line-container emailaddresses" id="{$module}emailAddressesTable{$index}">
	...
	<div class="col-xs-12 col-md-12 email-address-lines-container">
		{*
		...
		<div class="row template email-address-line-container hidden">
			...
			<div class="col-xs-12 col-sm-6 email-address-options-container">
				<div class="row">
					<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 text-center email-address-option">
					...
					{if $useInvalid == true}
					<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 text-center email-address-option">
