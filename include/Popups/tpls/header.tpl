...
{{if isset($formData)}}
{$SEARCH_FORM_HEADER}
<table cellpadding="0" cellspacing="0" border="0" class="table-search-form-header__include">
	<tr>
		<td>
...
{{if isset($ADDFORM)}}
<div class="box-section addform-wrap__include">
...
<div id='addform' style='display:none;position:relative;z-index:2;left:0px;top:0px;'>
	<form name="form_QuickCreate_{$module}" id="form_QuickCreate_{$module}" {*onsubmit="return check_form('form_popupQuickCreate{$module}');"*} method="post" action="index.php">
		{$ADDFORMHEADER}
		<table cellpadding="0" cellspacing="0" border="0" class="table-addformsearch__include">
			<tr>
				<td>
...
<form action="index.php" method="post" name="MassUpdate" id="MassUpdate">
	...
	{$multiSelectData}
	<!-- <input class="btn btn-primary btn-select__include" type="button" id="MassUpdate_select_button" value='{$APP.LBL_SELECT_BUTTON_LABEL}' onclick="send_back_selected('{$module}',document.MassUpdate,'mass[]','{$APP.ERR_NOTHING_SELECTED}');"> -->
{{/if}}