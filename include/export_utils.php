...
function export($type, $records = null, $members = false, $sample = false)
{
    ...
    foreach ($fields_array as $key => $dbname) {
        ...
        if (
            isset($focus->field_name_map[$key])  && isset($focus->field_name_map[$key]['exportable'])
    ...
    if ($populate) {
        ...
        while ($val = $db->fetchByAssoc($result, false)) {
            ...
            foreach ($val as $key => $value) {
                ...
                if (
                    isset($focus->field_name_map[$fieldNameMapKey])  && isset($focus->field_name_map[$fieldNameMapKey]['exportable']) &&
                ...
                if (isset($focus->field_name_map[$fieldNameMapKey])  && $focus->field_name_map[$fieldNameMapKey]['type']) {
                    ...
                    switch ($fieldType) {
                        ...
                        case 'enum':
                            if (
                                isset($focus->field_name_map[$fields_array[$key]]['options']) &&
