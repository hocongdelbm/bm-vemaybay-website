...
function smarty_function_sugar_action_menu($params, &$smarty)
{
    ...
    if (is_array($params['buttons'])) {
        return '<div class="action_buttons with_params--in-include d-flex align-items-center gap-2">' . implode_r(' ', $params['buttons'], true).'</div>';
    } else if(is_array($params)) {
        return '<div class="action_buttons no_params--in-include">' . implode_r(' ', $params, true).'</div>';
    }
