...
if ( typeof(SUGAR.field.file) == 'undefined' ) {
    SUGAR.field.file = {
        deleteAttachment: function(elemBaseName, docTypeName, elem) {
            ...
            // Fix error delete attachment - DucPham 23/01/2024
            var cObj = YAHOO.util.Connect.asyncRequest('POST', 'index.php?entryPoint=deleteAttachment', {success: success, failure: success});
