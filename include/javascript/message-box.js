(function( $ ) {
  ...
  $.fn.messageBox = function (options) {
    ...
    self.headerContent = '<button type="button" class="close btn-cancel in_include" aria-label="Close"><span aria-hidden="true"><svg aria-hidden="true" class="xvijh9v xhhsvwb x1ty9z65 xgzva0m" height="24px" viewBox="0 0 24 24" width="24px"><g stroke="#BCC0C4" stroke-linecap="round" stroke-width="2"><line x1="6" x2="18" y1="6" y2="18"></line><line x1="6" x2="18" y1="18" y2="6"></line></g></svg></span></button><h4 class="modal-title"></h4>';
    self.footerContent = '<button class="button btn-ok btn btn-primary" type="button">'+SUGAR.language.translate('','LBL_OK')+'</button> <button class="button btn-cancel btn btn-secondary" type="button">'+SUGAR.language.translate('','LBL_CANCEL_BUTTON_LABEL')+'</button> ';
