...
$mod_strings = array(
    ...
    'LBL_TIME_AGO' => 'trước',
// Activity stream
    'CREATED_ACCOUNT' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: it is used in the sentence "Administrator created a new account" PR 10037 Suite7
    'CREATED_CONTACT' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: it is used in the sentence "Administrator created a new contact"
    'CREATED_OPPORTUNITY' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: it is used in the sentence "Administrator created a new opportunity"
    'CREATED_CASE' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: it is used in the sentence "Administrator created a new case"
    'CREATED_LEAD' => 'tạo một <b>NEW</b> {0}', // For fusional (inflected) languages: it is used in sentence "Administrator created a new lead"
