...
if(isAllowedUser()) {
    if(ACLController::checkAccess('EC_Vouchers', 'edit', true)){
        $module_menu[]=Array("index.php?module=EC_Vouchers&action=createvouchers&return_module=EC_Vouchers&return_action=DetailView", $mod_strings['LNK_MULTIPLE_NEW_RECORDS'],"CreateEC_Vouchers", 'EC_Vouchers');
    }
}
