        ...
        $duration = '
            <div class="from-to-date--wrap d-inline-flex gap-2 align-items-center">
                <div class="dateTime d-flex gap-2 position-relative">
                    <input type="text" id="start_time" name="start_time" value="'.(!empty($_POST['start_time']) ? $_POST['start_time'] : $this->bean->start_time).'" class="date_input box-input">
                    <button class="icon_dateTime" type="button" id="start_time_trigger" onclick="return false;">
                ...
                <div class="dateTime d-flex gap-2 position-relative">
                    <input type="text" id="end_time" name="end_time" value="'.(!empty($_POST['end_time']) ? $_POST['end_time'] : $this->bean->end_time).'" class="date_input box-input">
                    <button class="icon_dateTime" type="button" id="end_time_trigger" onclick="return false;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-calendar2" viewBox="0 0 16 16">
                            <path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM2 2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H2z"></path>
                            <path d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5V4z"></path>
                        </svg>
