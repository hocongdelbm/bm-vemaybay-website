...
<div id="welcome" class="screen">
    ...
    <div class="nav-buttons">
        <input title="{$MOD.LBL_WIZARD_SKIP_BUTTON}"  
            onclick="document.location.href='{$SKIP_URL}';" class="btn btn-danger"  
...
<div id="smtp" class="screen">
                            ...
                            <tr>
                                <td width="50%" cellspan="2" scope="row" nowrap>
                                    <input title="{$APP.LBL_CLEAR_BUTTON_TITLE}"
                                        class="btn btn-danger" type="button" name="btn_clear" accesskey="{$APP.LBL_CLEAR_BUTTON_KEY}" value="{$APP.LBL_CLEAR_BUTTON_LABEL}"
                                        onclick="clearEmailFields();" />&nbsp;                                    
                                    <input type="button" class="btn btn-primary" value="{$APP.LBL_EMAIL_TEST_OUTBOUND_SETTINGS}" 
    ...
    <div class="nav-buttons">
        ...
        <input title="{$MOD.LBL_WIZARD_CONTINUE_BUTTON}" class="btn btn-primary"
