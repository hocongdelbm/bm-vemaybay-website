...
if (ACLController::checkAccess('EC_Banks', 'import', true)) {
    $module_menu[] = array('index.php?module=Import&action=Step1&import_module=EC_Banks&return_module=EC_Banks&return_action=index', $mod_strings['LNK_IMPORT_EC_BANKS'], 'Import', 'EC_Banks');
}
