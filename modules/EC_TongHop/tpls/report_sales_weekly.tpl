...
<div class="box-section overflow-auto position-relative mt-0">
	...
	<form id="ec_search_form" name="search_form" method="POST" action="index.php?module=EC_TongHop&action=report_sales_weekly&date_select={$CURRENT_OPTION}">
	...
	<form method="post" action="index.php?module=EC_TongHop&action=report_sales_weekly&date_select={$CURRENT_OPTION}" name="frmEditCostQc" id="frmEditCostQc">
		<input type="hidden" name="module" id="module" value="EC_TongHop">
		<input type="hidden" name="action" id="action" value="report_sales_weekly">
