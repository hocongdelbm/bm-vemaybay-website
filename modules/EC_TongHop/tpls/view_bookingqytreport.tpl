...
<div class="box-section overflow-auto position-relative mt-0">
	...
	<form id="ec_search_form" name="search_form" method="POST" action="index.php?module=EC_TongHop&action=bookingqtyreport">
		...
		<div class="button-action--wrap">
			<input type="submit" id="btnSearch" name="search" class="btn btn-primary button-action" value="Tìm kiếm" title="Tìm kiếm"/>
