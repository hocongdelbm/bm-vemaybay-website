...
<div class="title-wrap d-flex align-items-center justify-content-between gap-2">
	...
	<svg xmlns="http://www.w3.org/2000/svg" id="filter_report" width="32" height="32" fill="currentColor"
		class="bi bi-filter d-xxl-none d-xl-none d-lg-none d-block" viewBox="0 0 16 16">
		<path
...
<div class="box-section overflow-auto position-relative mt-0">
	...
	<form id="ec_search_form" name="search_form" method="POST"
		action="index.php?module=EC_TongHop&action=bookingqtyreport">
