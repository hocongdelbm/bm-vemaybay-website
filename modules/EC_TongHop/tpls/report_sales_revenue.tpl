        ...
        $(document).ready(function () {
            ...
            $('input[type=radio][name=optionRadio]').change(function() {
               ...
               $('#to_date').val($('input[name=optionRadio]:checked').attr('todate'));
				...
				$('#rc_date_select').prop('selectedIndex', 0); 
            });
        ...
        <table id="total_ticket_report_tbl" cellpadding="0" cellspacing="0" class="table-total-sale__booking table-details__booking">
            <thead>
                <tr class="head">
                    ...
                    {/if}
                    <th align="center" width="3%" class="hide-mobile">#</th>
                    <th align="center" width="8%">Booking</th>
                    <th align="center" width="3%">Vé</th>
                    <th align="center" width="15%" class="hide-mobile">Ghi chú</th>
                    <th align="center" width="7%" class="hide-mobile">Doanh thu</th>
                    <th align="center" width="7%" class="hide-mobile">Giá mua</th>
                    <th align="center" width="7%">Ds / Sử dụng điểm</th>
                    <th align="center" width="7%" class="hide-mobile">Phiếu thu</th>
                    <th align="center" width="12%">Nhân viên</th>
                    <th align="center" width="7%" class="hide-mobile">TĐ Khách TT</th>
                    <th align="center" width="7%" class="hide-mobile">Ngày tạo</th>
                    <th align="center" width="7%" class="hide-mobile">Ngày xuất vé</th>
