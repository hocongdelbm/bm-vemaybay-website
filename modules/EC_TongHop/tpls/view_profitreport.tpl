...
<div class="box-section position-relative mt-0">
    ...
    <form action="index.php" method="post" name="search_form" id="ec_search_form">
        ...
        <div class="button-action--wrap">
            <input type="submit" id="btnSearch" name="btnSearch" class="btn btn-primary" value="Tìm kiếm" title="Tìm kiếm"/>
    ...
    <table class="table-profitreport table-details__booking mt-3" border="0" cellpadding="0" cellspacing="0" id="profit_list">
        <thead>
            <tr>
                <th width="5%" align="center" class="hide-mobile">STT</th>
                <th width="15%" align="center">Tên mục</th>
                <th width="15%" align="center">Số tiền</th>
                <th width="15%" align="center">Tháng trước</th>
                <th width="15%" align="center">% tháng trước</th>
                <th width="15%" align="center" class="hide-mobile">Quý này</th>
                <th align="center" class="hide-mobile">% quý này</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td align="center" class="hide-mobile">1</td>
                ...
                <td align="right" class="hide-mobile">{$TOTAL_AMOUNT_CURR_QUARTER}</td>
                <td align="right" class="hide-mobile">{$TOTAL_AMOUNT_CURR_QUARTER_PERCENT}</td>
            </tr>
            
            <tr>
                <td align="center" class="hide-mobile">2</td>
                ...
                <td align="right" class="hide-mobile">{$TOTAL_BOUGHT_AMOUNT_CURR_QUARTER}</td>
                <td align="right" class="hide-mobile">{$TOTAL_PROFIT_CURR_QUARTER_PERCENT}</td>
            </tr>
            
            <tr>
                <td align="center" class="bg-yellow fw-semibold hide-mobile">3</td>
                ...
                <td align="right" class="bg-yellow fw-semibold hide-mobile">{$TOTAL_PROFIT_CURR_QUARTER}</td>
                <td align="right" class="bg-yellow fw-semibold hide-mobile">{$TOTAL_PROFIT_CURR_QUARTER_PERCENT}</td>
            </tr>
            
            {$DATA}
            
            <tr>
                <td align="center" class="bg-yellow fw-semibold hide-mobile">{$LAST_ROW_NUM}</td>
                ...
                <td align="right" class="bg-yellow fw-semibold hide-mobile">{$TOTAL_PROFIT_FINAL_CURR_QUARTER}</td>
                <td align="right" class="bg-yellow fw-semibold hide-mobile">{$TOTAL_PROFIT_FINAL_CURR_QUARTER_PERCENT}</td>
            </tr>
