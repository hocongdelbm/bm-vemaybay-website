...
$dictionary['Account'] = array(
    ...
    'fields' => array(
        ...
        // Modified by DucPham - 11/04/2023 
        // Change len from 10 to 50 into LuongQC
        'sic_code' => array(
            'name'      => 'sic_code',
            'vname'     => 'LBL_SIC_CODE',
            'type'      => 'varchar',
        ...
        /********** CUSTOM **********/
        // Lên báo cáo dòng tiền
        'is_reported' => array(
            'name'        => 'is_reported',
            'vname'       => 'LBL_IS_REPORTED',
            'type'        => 'bool',
            'massupdate'  => false,
        ),
        'balance_observe' => array(
            'required'      => false,
            'name'          => 'balance_observe',
            'vname'         => 'LBL_BALANCE_OBSERVE',
            'type'          => 'bool',
            'massupdate'    => 0,
            'comments'      => '',
            'help'          => '',
        ...
        'is_stop_tracking' => array(
            'required' => false,
            'name' => 'is_stop_tracking',
            'vname' => 'LBL_IS_STOP_TRACKING',
            'type' => 'bool',
            'massupdate' => 0,
            'comments' => '',
            'help' => '',
