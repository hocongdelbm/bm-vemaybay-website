...
function send_massassign(mode, no_record_txt, start_string, end_string, del) {
	...
	return false;
		...
		<form action='index.php' method='post' name='MassAssign_SecurityGroups' id='MassAssign_SecurityGroups' class='box-section mt-3 d-none'>
            ...
            <div id='massassign_form' class='d-flex gap-2 align-items-center'>$form_header
                <table cellpadding='0' cellspacing='0' border='0' width='100%'>
                    <tr>
                        <td class='listViewButtons'>
                            <div class="d-flex align-items-center gap-2">
                                <input type='submit' class='btn btn-primary' name='Assign' value='${current_module_strings['LBL_ASSIGN']}' onclick="return send_massassign('selected', '{$app_strings['LBL_LISTVIEW_NO_SELECTED']}','${current_module_strings['LBL_ASSIGN_CONFIRM']}','${current_module_strings['LBL_CONFIRM_END']}',0);" class='button'>
                                <input type='submit' class='btn btn-danger' name='Remove' value='${current_module_strings['LBL_REMOVE']}' onclick="return send_massassign('selected', '{$app_strings['LBL_LISTVIEW_NO_SELECTED']}','${current_module_strings['LBL_REMOVE_CONFIRM']}','${current_module_strings['LBL_CONFIRM_END']}',1);" class='button'>
                            </div>
                        </td>
                    </tr>
                </table>
