...
foreach ($defaultGroups as $default_id => $defaultGroup) {
	...
	<td class='dataLabel' width='40%'>
		<input type='submit' tabindex='1' class='btn btn-primary' onclick=\"this.form.remove_default_id.value='".$default_id."'; this.form.action.value='SaveConfig'; this.form.return_module.value='SecurityGroups'; this.form.return_action.value='config';\" value='".$mod_strings['LBL_REMOVE_BUTTON_LABEL']."'/>
	</td>
	</tr>";
}
