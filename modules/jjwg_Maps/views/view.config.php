...
class Jjwg_MapsViewConfig extends SugarView
{
    ...
    public function display()
    {
        ...
        <h1 class="title"><strong><?php echo $GLOBALS['mod_strings']['LBL_CONFIG_TITLE']; ?></strong></h1>
        ...
        <form name="settings" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
            ...
            <div class="d-flex align-items-center gap-2">
                <input class="btn btn-primary" type="submit" tabindex="101" name="submit" value="  <?php echo $GLOBALS['app_strings']['LBL_SAVE_BUTTON_LABEL']; ?>  " align="bottom">
                <input type="button" class="btn btn-danger" tabindex="102" name="cancel" value="  <?php echo $GLOBALS['app_strings']['LBL_CANCEL_BUTTON_LABEL']; ?>  " align="bottom" onclick="document.location.href='index.php?module=Administration&amp;action=index'" title="">
            </div>

            <div class="box-section">
            <table class="table-edit table-setting__config-jjwg_maps" cellpadding="0" cellspacing="12" border="0">
                <tr>
                    <td><strong><?php echo $GLOBALS['mod_strings']['LBL_GOOGLE_API_KEY']; ?> </strong></td>
                    <td>
                        <input class="box-input" type="text" name="google_maps_api_key" id="google_maps_api_key" value="<?php echo (isset($GLOBALS['jjwg_config']['google_maps_api_key'])) ? htmlspecialchars($GLOBALS['jjwg_config']['google_maps_api_key']) : htmlspecialchars($GLOBALS['jjwg_config_defaults']['google_maps_api_key']); ?>" title='' tabindex='139' size="70" maxlength="255">
                    </td>
                </tr>
                <tr>
                    <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <input class="box-input" type="text" name="valid_geocode_modules" id="valid_geocode_modules" value="<?php echo (isset($GLOBALS['jjwg_config']['valid_geocode_modules'])) ? htmlspecialchars(implode(', ', $GLOBALS['jjwg_config']['valid_geocode_modules'])) : htmlspecialchars(implode(', ', $GLOBALS['jjwg_config_defaults']['valid_geocode_modules'])); ?>" title='' tabindex='107' size="100" maxlength="999">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="valid_geocode_tables" id="valid_geocode_tables" value="<?php echo (isset($GLOBALS['jjwg_config']['valid_geocode_tables'])) ?
                                                                                                            htmlspecialchars(implode(', ', $GLOBALS['jjwg_config']['valid_geocode_tables'])) :
                                                                                                            htmlspecialchars(implode(', ', $GLOBALS['jjwg_config_defaults']['valid_geocode_tables'])); ?>" title='' tabindex='108' size="100" maxlength="999"><br />
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                ...
                <tr>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Accounts" tabindex="111" name="address_type_Accounts" title="">
                ...
                <tr>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Contacts" tabindex="112" name="address_type_Contacts" title="">
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                        <?php echo htmlspecialchars($address_types_primary_or_alt[$GLOBALS['jjwg_config_defaults']['geocode_modules_to_address_type']['Contacts']]); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Leads" tabindex="113" name="address_type_Leads" title="">
                            <?php foreach ($address_types_primary_or_alt as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                        <?php echo htmlspecialchars($address_types_primary_or_alt[$GLOBALS['jjwg_config_defaults']['geocode_modules_to_address_type']['Leads']]); ?>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Opportunities" tabindex="114" name="address_type_Opportunities" title="">
                            <?php foreach ($address_types_billing_or_shipping as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                        <?php echo htmlspecialchars($address_types_billing_or_shipping[$GLOBALS['jjwg_config_defaults']['geocode_modules_to_address_type']['Opportunities']]); ?>
                ...
                <tr>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Cases" tabindex="115" name="address_type_Cases" title="">
                            <?php foreach ($address_types_billing_or_shipping as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                ...
                <tr>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Project" tabindex="116" name="address_type_Project" title="">
                            <?php foreach ($address_types_billing_or_shipping as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                        <?php echo htmlspecialchars($address_types_billing_or_shipping[$GLOBALS['jjwg_config_defaults']['geocode_modules_to_address_type']['Project']]); ?>
                ...
                <tr>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Meetings" tabindex="117" name="address_type_Meetings" title="">
                ...
                <tr>
                    ...
                    <td>
                        <select class="box-select" id="address_type_Prospects" tabindex="118" name="address_type_Prospects" title="">
                            <?php foreach ($address_types_primary_or_alt as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                        <?php echo htmlspecialchars($address_types_primary_or_alt[$GLOBALS['jjwg_config_defaults']['geocode_modules_to_address_type']['Prospects']]); ?>
                    </td>
                </tr>
                <?php
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <select class="box-select" id="address_type_<?php echo $module; ?>" tabindex="118" name="address_type_<?php echo $module; ?>" title="">
                            ...
                            &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                            <?php echo htmlspecialchars($address_types_all[$GLOBALS['jjwg_config_defaults']['geocode_modules_to_address_type']['Contacts']]); ?>
                        </td>
                    </tr>
                <?php
                } ?>
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Accounts" id="grouping_field_Accounts" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Accounts'])) ?
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Accounts']) :
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Accounts']); ?>" title='' tabindex='121' size="25" maxlength="75">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Contacts" id="grouping_field_Contacts" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Contacts'])) ?
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Contacts']) :
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Contacts']); ?>" title='' tabindex='122' size="25" maxlength="32">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Leads" id="grouping_field_Leads" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Leads'])) ?
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Leads']) :
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Leads']); ?>" title='' tabindex='123' size="25" maxlength="32">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Opportunities" id="grouping_field_Opportunities" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Opportunities'])) ?
                                                                                                                            htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Opportunities']) :
                                                                                                                            htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Opportunities']); ?>" title='' tabindex='124' size="25" maxlength="32">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Cases" id="grouping_field_Cases" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Cases'])) ?
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Cases']) :
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Cases']); ?>" title='' tabindex='125' size="25" maxlength="32">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Project" id="grouping_field_Project" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Project'])) ?
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Project']) :
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Project']); ?>" title='' tabindex='126' size="25" maxlength="32">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Meetings" id="grouping_field_Meetings" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Meetings'])) ?
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Meetings']) :
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Meetings']); ?>" title='' tabindex='127' size="25" maxlength="32">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="grouping_field_Prospects" id="grouping_field_Prospects" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field']['Prospects'])) ?
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field']['Prospects']) :
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Prospects']); ?>" title='' tabindex='128' size="25" maxlength="32">
                ...
                ?>
                    <tr>
                        ...
                        <td><input class="box-input" type="text" name="grouping_field_<?php echo $module; ?>" id="grouping_field_<?php echo $module; ?>" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_grouping_field'][$module])) ?
                                                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config']['map_markers_grouping_field'][$module]) :
                                                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_grouping_field']['Contacts']); ?>" title='' tabindex='128' size="25" maxlength="32">
                            &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="geocoding_api_url" id="geocoding_api_url" value="<?php echo (isset($GLOBALS['jjwg_config']['geocoding_api_url'])) ?
                                                                                                        htmlspecialchars($GLOBALS['jjwg_config']['geocoding_api_url']) :
                                                                                                        htmlspecialchars($GLOBALS['jjwg_config_defaults']['geocoding_api_url']); ?>" title='' tabindex='139' size="70" maxlength="255">
                        <br />
                        <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                        <?php echo htmlspecialchars($GLOBALS['jjwg_config_defaults']['geocoding_api_url']) ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="geocoding_api_secret" id="geocoding_api_secret" value="<?php echo (isset($GLOBALS['jjwg_config']['geocoding_api_secret'])) ?
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config']['geocoding_api_secret']) :
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config_defaults']['geocoding_api_secret']); ?>" title='' tabindex='140' size="25" maxlength="255">
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="geocoding_limit" id="geocoding_limit" value="<?php echo (isset($GLOBALS['jjwg_config']['geocoding_limit'])) ?
                                                                                                    htmlspecialchars($GLOBALS['jjwg_config']['geocoding_limit']) :
                                                                                                    htmlspecialchars($GLOBALS['jjwg_config_defaults']['geocoding_limit']); ?>" title='' tabindex='141' size="10" maxlength="25">
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="google_geocoding_limit" id="google_geocoding_limit" value="<?php echo (isset($GLOBALS['jjwg_config']['google_geocoding_limit'])) ?
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config']['google_geocoding_limit']) :
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config_defaults']['google_geocoding_limit']); ?>" title='' tabindex='142' size="10" maxlength="25">
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                ...
                <tr class="row odd">
                    ...
                    <td>
                        ...
                        <select class="box-select" id="allow_approximate_location_type" tabindex="143" name="allow_approximate_location_type" title="">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="export_addresses_limit" id="export_addresses_limit" value="<?php echo (isset($GLOBALS['jjwg_config']['export_addresses_limit'])) ?
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config']['export_addresses_limit']) :
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config_defaults']['export_addresses_limit']); ?>" title='' tabindex='144' size="10" maxlength="25">
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select class="box-select" id="address_cache_get_enabled" tabindex="145" name="address_cache_get_enabled" title="">
                            <?php foreach ($enabled_disabled as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                                                                                        if ($key == $enabled) {
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?> <?php echo htmlspecialchars($enabled_disabled[$GLOBALS['jjwg_config_defaults']['address_cache_get_enabled']]) ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select class="box-select" id="address_cache_save_enabled" tabindex="146" name="address_cache_save_enabled" title="">
                            <?php foreach ($enabled_disabled as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                                                                                        if ($key == $enabled) {
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?> <?php echo htmlspecialchars($enabled_disabled[$GLOBALS['jjwg_config_defaults']['address_cache_save_enabled']]) ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select class="box-select" id="logic_hooks_enabled" tabindex="148" name="logic_hooks_enabled" title="">
                            <?php foreach ($enabled_disabled as $key => $value) {
                            ?>
                                <option value="<?php echo htmlspecialchars($key); ?>" <?php
                                                                                        if ($key == $enabled) {
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?> <?php echo htmlspecialchars($enabled_disabled[$GLOBALS['jjwg_config_defaults']['logic_hooks_enabled']]) ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="map_markers_limit" id="map_markers_limit" value="<?php echo (isset($GLOBALS['jjwg_config']['map_markers_limit'])) ?
                                                                                                        htmlspecialchars($GLOBALS['jjwg_config']['map_markers_limit']) :
                                                                                                        htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_markers_limit']); ?>" title='' tabindex='150' size="10" maxlength="25">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="map_default_center_latitude" id="map_default_center_latitude" value="<?php echo (isset($GLOBALS['jjwg_config']['map_default_center_latitude'])) ?
                                                                                                                            htmlspecialchars($GLOBALS['jjwg_config']['map_default_center_latitude']) :
                                                                                                                            htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_default_center_latitude']); ?>" title='' tabindex='151' size="10" maxlength="25">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="map_default_center_longitude" id="map_default_center_longitude" value="<?php echo (isset($GLOBALS['jjwg_config']['map_default_center_longitude'])) ?
                                                                                                                            htmlspecialchars($GLOBALS['jjwg_config']['map_default_center_longitude']) :
                                                                                                                            htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_default_center_longitude']); ?>" title='' tabindex='152' size="10" maxlength="25">
                ...
                <tr>
                    ...
                    <td>
                        <select class="box-select" id="map_default_unit_type" tabindex="153" name="map_default_unit_type" title="">
                        ...
                        &nbsp; <?php echo $GLOBALS['mod_strings']['LBL_CONFIG_DEFAULT']; ?> <?php echo htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_default_unit_type']) ?>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="map_default_distance" id="map_default_distance" value="<?php echo (isset($GLOBALS['jjwg_config']['map_default_distance'])) ?
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config']['map_default_distance']) :
                                                                                                            htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_default_distance']); ?>" title='' tabindex='154' size="10" maxlength="25">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="map_duplicate_marker_adjustment" id="map_duplicate_marker_adjustment" value="<?php echo (isset($GLOBALS['jjwg_config']['map_duplicate_marker_adjustment'])) ?
                                                                                                                                    rtrim(number_format($GLOBALS['jjwg_config']['map_duplicate_marker_adjustment'], 8), '0.') :
                                                                                                                                    rtrim(number_format($GLOBALS['jjwg_config_defaults']['map_duplicate_marker_adjustment'], 8), '0.'); ?>" title='' tabindex='155' size="10" maxlength="25">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="map_clusterer_grid_size" id="map_clusterer_grid_size" value="<?php echo (isset($GLOBALS['jjwg_config']['map_clusterer_grid_size'])) ?
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config']['map_clusterer_grid_size']) :
                                                                                                                    htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_clusterer_grid_size']); ?>" title='' tabindex='156' size="10" maxlength="25">
                ...
                <tr>
                    ...
                    <td><input class="box-input" type="text" name="map_clusterer_max_zoom" id="map_clusterer_max_zoom" value="<?php echo (isset($GLOBALS['jjwg_config']['map_clusterer_max_zoom'])) ?
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config']['map_clusterer_max_zoom']) :
                                                                                                                htmlspecialchars($GLOBALS['jjwg_config_defaults']['map_clusterer_max_zoom']); ?>" title='' tabindex='157' size="10" maxlength="25">
            ...
            <div class="d-flex align-items-center gap-2">
                <input type="submit" class="btn btn-primary" tabindex="211" name="submit" value="  <?php echo $GLOBALS['app_strings']['LBL_SAVE_BUTTON_LABEL']; ?>  " align="bottom">
                <input type="button" class="btn btn-danger" tabindex="212" name="cancel" value="  <?php echo $GLOBALS['app_strings']['LBL_CANCEL_BUTTON_LABEL']; ?>  " align="bottom" onclick="document.location.href='index.php?module=Administration&amp;action=index'" title="">
            </div>
        </form>
