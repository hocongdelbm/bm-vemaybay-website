...
class Viewchatzalo extends SugarView {
    ...
    public function get_list_user($offset = 0, $current_list_user = []) {
        ...
        while(count($list_zalo_id['interaction']) < $this->limit_chat_box) {
