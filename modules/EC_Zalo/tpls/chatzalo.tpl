                            ...
                            <div class="dropdown dropdown-type-list">
                                <button type="button" class="btn btn-dropdown" data-bs-toggle="dropdown">
                                    ...
                                    <i class="icon icon_dropdown">
                                        <svg width="20px" height="20px" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#000000"><path d="M6 9L12 15L18 9" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path></svg>
                                    </i>
                                </button>
                        ...
                        <div class="group-feed">
                            <section class="user-current">
                                    ...
                                    <div class="item-message flexBox">
                                        ...
                                        <section class="dropdown choose_label">
                                            <div class="dropdown_btn">
                                                <div class="sc-dAbbbq edZhmX input_choose" color="#69686D" backgroundcolor="#E8E7EC">
                                                    <div class="title">Nhãn</div>
                                                    <svg stroke="currentColor" fill="none" stroke-width="2"
                                                        viewBox="0 0 24 24" stroke-linecap="round"
                                                        stroke-linejoin="round" color="#69686D" height="20" width="20"
                                                        xmlns="http://www.w3.org/2000/svg"
                                                        style="color: rgb(105, 104, 109);">
                                                        <polyline points="6 9 12 15 18 9"></polyline>
                                                    </svg>
                                                </div>
                                            </div>
                                            <div id="header_tags_chat" class="dropdown_content dropdown_content_label"></div>
                                        </section>
                                    </div>
                                </div>
                                ...
                                <a id="func-slide" class="func-slide slide">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-layout-sidebar-inset-reverse" viewBox="0 0 16 16">
                                ...
                                <div class="add-msg-box">
                                    ...
                                    <div class="add-msg-box-txtArea">
                                        <div class="preview_upload">
                                            <img id="preview_image_upload" class="preview-image-upload" src="#" alt="Upload image" />
                                        ...
                                        <div class="content_mess_input">
                                            <textarea name="message_content" class="textarea" maxlength="2000" placeholder="Nhập nội dung tin nhắn..."></textarea>
                                            <button id="send_message" class="content_send btn btn-primary" action="text">Gửi</button>
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        <div class="zalochat_profile--wrap">
                            <div class="head py-12">
                                ...
                                <div class="profile_link mt-12" style="justify-content: space-between;">
                                    ...
                                    <div class="flexBox">
                                        <a id="profile_chat_link" href="" class="link_content limit_text" target="_blank">https://oa.zalo....share</a>
