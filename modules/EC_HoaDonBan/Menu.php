...
if ($editing_rights) $module_menu[] = ["index.php?module=EC_HoaDonBan&action=ioinvoice&return_module=EC_HoaDonBan&return_action=DetailView", "Bảng kê mua vào - bán ra", 'EC_HoaDonBan', 'EC_HoaDonBan'];
