...
$dictionary['EC_Airports'] = array(
    ...
    'fields' => array(
        ...
        'icao_code' => array(
            ...
            'vname'     => 'LBL_ICAO_CODE',
            'type'      => 'varchar',
            'comment'   => 'Mã ICAO sân bay: VVNB, VVTS, WSSS, EGLL, ...',
            'len'       => 4,
            'importable' => 'true',
            'audited'   => 1,
            'reportable' => 1,
        ...
        'country' => array(
            ...
            'vname'     => 'LBL_COUNTRY',
            'type'      => 'enum',
            'comment'   => 'Quốc gia và vùng lãnh thổ của sân bay',
            'len'       => 2,
            'options'   => 'region_dom',
            'default'   => '',
            'importable' => 'true',
    ...
    'indices' => array(
        ...
        array('name' => 'idx_airports_country',         'type' => 'index',  'fields' => array('country')),
