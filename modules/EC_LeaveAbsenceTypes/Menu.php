...
// if(ACLController::checkAccess('EC_LeaveAbsenceTypes', 'import', true))$module_menu[]=Array("index.php?module=Import&action=Step1&import_module=EC_LeaveAbsenceTypes&return_module=EC_LeaveAbsenceTypes&return_action=index", $app_strings['LBL_IMPORT'],"Import", 'EC_LeaveAbsenceTypes');
