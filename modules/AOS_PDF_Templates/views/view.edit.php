...
class AOS_PDF_TemplatesViewEdit extends ViewEdit
{
    ...
    public function setFields()
    {
		...
		<input type='button' tabindex="70" onclick='insert_variable(document.EditView.variable_text.value, "email_template_editor");' class='btn btn-primary' value='${mod_strings['LBL_BUTTON_INSERT']}'>
        </div>
        <script type="text/javascript">populateModuleVariables("$type");</script>
HTML;
