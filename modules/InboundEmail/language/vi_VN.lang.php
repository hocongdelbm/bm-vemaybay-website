...
$mod_strings = array(
    ...
    'LBL_FROM_ADDR_DESC' => 'Địa chỉ email được cung cấp ở đây có thể không xuất hiện trong phần "Từ" địa chỉ của email được gửi do hạn chế của nhà cung cấp dịch vụ Email. Trong những trường hợp này, địa chỉ email được định nghĩa trong máy chủ Email đi sẽ được sử dụng.', // as long as XTemplate doesn't support output escaping, transform quotes to html-entities right here (bug #48913)
    ...
    'LBL_SERVER_PORT' => 'Cổng máy chủ Email',
    ...
    'LNK_LIST_CREATE_NEW_PERSONAL' => 'Tạo tài khoản mới',
    ...
    'LBL_DISTRIB_METHOD' => 'Phương pháp phân phối',
    ...
    'LBL_SET_AS_DEFAULT_BUTTON' => 'Set mặc định',
