...
echo '<tr>
		...
		<tr align="center">
			<td>&nbsp;</td>
			<td  valign="top">
				<select class="box-select" ' . $multipleString . ' size="12" name="inboundmailboxes" id="sf_inboundmailboxes">
				</select>
			</td>
		</tr>
		<tr>
		...
		<tr align="center">
			<td>&nbsp;</td>
			<td>
				<input type="button" class="btn btn-success btn-done" value="' . $app_strings['LBL_DONE_BUTTON_LABEL'] . '" onclick="setMailbox();">
				<input type="button" class="btn btn-secondary btn-cancel" value="' . $app_strings['LBL_EMAIL_CANCEL'] . '" onclick="SUGAR.inboundEmail.listDlg.hide()">
			</td>
		</tr>';
