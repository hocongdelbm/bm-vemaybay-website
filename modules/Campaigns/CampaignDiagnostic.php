...
$mboxTable = "<table border ='0' width='100%'  class='detail view table-details__booking mt-4' cellpadding='0' cellspacing='0'>";
...
if (isset($mbox) && count($mbox)>0) {
    ...
    $mboxTable .= "<thead><tr><th scope='col' width='20%'><b>".$mod_strings['LBL_MAILBOX_NAME']."</b></th>"
                   ...
                   .  " <th scope='col' width='20%'><b>".$mod_strings['LBL_LIST_STATUS']."</b></th></tr></thead>";
...
$conf_msg="<table border='0' width='100%' class='detail view table-details__booking' cellpadding='0' cellspacing='0'>";
if (strstr($focus->settings['notify_fromaddress'], 'example.com')) {
    ...
    $conf_msg .= "<thead><tr><th scope='col' width='20%'><b>".$mod_strings['LBL_WIZ_FROM_NAME']."</b></th>"
    ...
    if (strtolower(isSmtp($focus->settings['mail_sendtype'] ?? ''))) {
        $conf_msg .= " <th scope='col' width='20%'><b>".$mod_strings['LBL_MAIL_SMTPSERVER']."</b></th>"
               .  " <th scope='col' width='20%'><b>".$mod_strings['LBL_MAIL_SMTPUSER']."</b></th></tr></thead>";
    } else {
        $conf_msg .= "</tr></thead>";
    }
