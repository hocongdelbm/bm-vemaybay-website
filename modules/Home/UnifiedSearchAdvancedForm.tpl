...
<input type='hidden' id='showGSDiv' name='showGSDiv' value='{$SHOWGSDIV}'>
	...
	<tr style='padding-bottom: 10px'>
		<td class="submitButtons" colspan='8' nowrap>
			<input id='searchFieldMain' title="{$LBL_SEARCH}" class='box-input searchField' type='text' size='80' name='query_string' value='{$query_string}'>
		    <input type="submit" title="{$LBL_SEARCH_BUTTON_TITLE}" class="btn btn-search" value="{$LBL_SEARCH_BUTTON_LABEL}">&nbsp;
