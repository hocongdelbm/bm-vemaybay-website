...
class Viewbaocaongay extends SugarView {
	...
	function populateContent($smartyobj){
		...
		while($row = $db->fetchByAssoc($res)){
		  ...
		  <td align="center" style="font-weight:bold; font-size:15px;"><a class="view_detail" module="Tasks" uid="'.$row['uid'].'" title="Xem chi tiết">'.format_number($row['total_task']).'</a></td>
		  <td align="center" style="font-weight:bold; font-size:15px;"><a class="view_detail" module="Contacts" uid="'.$row['uid'].'" title="Xem chi tiết">'.format_number($row['total_contact']).'</a></td>
		  <td align="center" style="font-weight:bold; font-size:15px;"><a class="view_detail" module="Meetings" uid="'.$row['uid'].'" title="Xem chi tiết">'.format_number($row['total_meeting']).'</a></td>
		  <td align="center" style="font-weight:bold; font-size:15px;"><a class="view_detail" module="Calls" uid="'.$row['uid'].'" title="Xem chi tiết">'.format_number($row['total_call']).'</a></td>
		  <td align="center" style="font-weight:bold; font-size:15px;"><a class="view_detail" module="Opportunities" uid="'.$row['uid'].'" title="Xem chi tiết">'.format_number($row['total_opp']).'</a></td>
			</tr>';
			$i++;
		}
