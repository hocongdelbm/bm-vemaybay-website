...
if (ACLController::checkAccess('EC_Receipt_Voucher', 'edit', true) || ACLController::checkAccess('EC_Payment_Voucher', 'edit', true) || $current_user->id == '7c20e013-b0d6-e1f3-b113-53deed58f0a2')
...
// if (ACLController::checkAccess('EC_Receipt_Voucher', 'edit', true)) $module_menu[] = array("index.php?module=EC_Receipt_Voucher&action=cashflow&return_module=EC_Receipt_Voucher&return_action=cashflow", 'Báo cáo dòng tiền', "finance-16", 'EC_Receipt_Voucher');
