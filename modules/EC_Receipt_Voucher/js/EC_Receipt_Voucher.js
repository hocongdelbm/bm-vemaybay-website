...
$(document).ready(function() {
	...
	var loai_thu_arr 	= ['4', '5', '11', '12', '13', '14', '16'];
	...
	$('#EditView').submit(function(e){
		...
		if(action == 'Save'){
			...
			// Sell amount
			if(loai_thu_arr.includes(loai_thu) && sell_amount == '' && loai_thu != '4' && loai_thu != '5') {
				$text_warning = 'Giá bán không được trống!';
				showToastWarning($text_warning);
				$('#bought_amount').focus();
				return false;
			}
			if(supplier2_id != '' && sell_amount2 == '' && loai_thu != '4' && loai_thu != '5'){
				$text_warning = 'Giá bán không được trống!';
				showToastWarning($text_warning);
				$('#sell_amount2').focus();
				return false;
			}
			if(supplier3_id != '' && sell_amount3 == '' && loai_thu != '4' && loai_thu != '5'){
				$text_warning = 'Giá bán không được trống!';
				showToastWarning($text_warning);
				$('#sell_amount3').focus();
				return false;
