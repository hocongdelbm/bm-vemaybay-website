...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="actionsContainer">
	<tr>
		<td>
			<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="btn btn-primary" id="btn_save" type="submit" onclick="addcheck(form);return check_form('ConfigurePasswordSettings');"  name="save" value="{$APP.LBL_SAVE_BUTTON_LABEL}" >
			<input title="{$MOD.LBL_CANCEL_BUTTON_TITLE}" id="btn_cancel" onclick="document.location.href='index.php?module=Administration&action=index'" class="btn btn-danger"  type="button" name="cancel" value="{$APP.LBL_CANCEL_BUTTON_LABEL}" >
		</td>
	</tr>
</table>

<div class="box-section">
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-config table-config__password"> 
	<tr>
		<td>
						<table id="sysGeneratedId" name="sysGeneratedName" width="100%" border="0" cellspacing="1" cellpadding="0" class="table-edit table-config__child">
							<tr>
											...
											<td colspan='4'>
												<table width="100%" id='syst_generated_pwd_table' border="0" cellspacing="1" cellpadding="0">
													<tr>
														...
														{/if}
															<input type='text' maxlength="3" and style="width:3em"  name='passwordsetting_systexpirationtime' value='{$config.passwordsetting.systexpirationtime}'>
														...
														<td colspan='2' width='40%'>
															...
															<input type='text' maxlength="3" and style="width:3em"  name='passwordsetting_systexpirationlogin' value="{$config.passwordsetting.systexpirationlogin}">
			...
			<table id="pwdsec_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table-edit table-config__child">
				<tr>
			...
			<table id="userResetPassId" name="userResetPassName" width="100%" border="0" cellspacing="1" cellpadding="0" class="table-edit table-config__child">
							<tr>
								<th align="left" scope="row" colspan="2">
									<h4>{$MOD.LBL_PASSWORD_USER_RESET}</h4>
								</th>
							</tr>
							<tr>
											...
											<td colspan="3">
												<table width="100%" border="0" cellspacing="0" cellpadding="0" id="forgot_password_table">
													<tr>
														...
														{/if}
															<input type='text' maxlength="3" and style="width:3em" name='passwordsetting_linkexpirationtime'  value='{$config.passwordsetting.linkexpirationtime}'>
						...
						<table id="emailTemplatesId" name="emailTemplatesName" width="100%" border="0" cellspacing="1" cellpadding="0" class="table-edit table-config__child">
							<tr>
								<th align="left" scope="row" colspan="4">
									<h4>
										...
										<tr>
									        ...
									        <td  >
										        <span>
													...
													<input type="button" class="btn btn-primary" onclick="javascript:open_email_template_form('generatepasswordtmpl')" value="{$MOD.LBL_PASSWORD_CREATE_TEMPLATE}" {$IE_DISABLED}>
													<input type="button" value="{$MOD.LBL_PASSWORD_EDIT_TEMPLATE}" class="btn btn-warning" onclick="javascript:edit_email_template_form('generatepasswordtmpl')" name='edit_generatepasswordtmpl' id='edit_generatepasswordtmpl' style="{$EDIT_TEMPLATE}">
												</span>
									        </td>
									        <td ></td>
									        <td  ></td>
										...
										<tr>
									        ...
									        <td  >
							        			<span>
													...
													<input type="button" class="btn btn-primary" onclick="javascript:open_email_template_form('lostpasswordtmpl')" value="{$MOD.LBL_PASSWORD_CREATE_TEMPLATE}" {$IE_DISABLED}>
													<input type="button" value="{$MOD.LBL_PASSWORD_EDIT_TEMPLATE}" class="btn btn-warning" onclick="javascript:edit_email_template_form('lostpasswordtmpl')" name='edit_lostpasswordtmpl' id='edit_lostpasswordtmpl' style="{$EDIT_TEMPLATE}">
												</span>
							        		 </td>
									        <td ></td>
									        <td ></td>
							...
							<tr>
								...
								<td>
									<span>
										...
										<input type="button" value="{$MOD.LBL_PASSWORD_EDIT_TEMPLATE}" class="btn btn-warning"
							...
							{/if}
							<table id='ldap_table' width="100%" border="0" cellspacing="0" cellpadding="0" class="table-edit table-config__child">
								<tr>
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<th align="left" scope="row" colspan='4'>
													<h4>{$MOD.LBL_LDAP_TITLE}</h4>
												</th>
											</tr>
											<tr>
                     ...
                     <table id = 'saml_table' width="100%" border="0" cellspacing="0" cellpadding="0" class="table-edit table-config__child">
                        <tr>
                           <td>
                              <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                 <tr>
                                    <th align="left" scope="row" colspan='4'><h4>{$MOD.LBL_SAML_TITLE}</h4></th>
                                 </tr>
                                 <tr>
                                    <td width="25%" scope="row" valign='middle'>
