...
?>
<div class="box-section ready-install">
...
if ($require_license) {
	...
	<table width='100%'>
	<tr>
	<td colspan="3"><ul class="tablist box-list d-flex gap-2 border">
	<li id="license_li" class="active box-item"><a id="license_link" class="current" href="javascript:selectTabCSS('license');">{$mod_strings['LBL_LICENSE']}</a></li>
	<li class="box-item" id="readme_li"><a id="readme_link" href="javascript:selectTabCSS('readme');">{$mod_strings['LBL_README']}</a></li>
	</ul></td>
	</tr>
	</table>
	<div id='license_div'>
	...
	<td align="left" valign="top" colspan=2>
        <div class="d-flex gap-2 align-items-center mt-2">
            <input type='radio' class='form-check-input' id='radio_license_agreement_accept' name='radio_license_agreement' value='accept'>
            <label class="form-check-label" for="radio_license_agreement_accept">{$mod_strings['LBL_ACCEPT']}</label>

            <input type='radio' class='form-check-input' id='radio_license_agreement_reject' name='radio_license_agreement' value='reject' checked>
            <label class="form-check-label" for="radio_license_agreement_reject">{$mod_strings['LBL_DENY']}</label>
        </div>
	</td>
...
<div class="d-flex align-items-center gap-2">
    <input type="submit" value="<?php echo $mod_strings['LBL_ML_COMMIT'];?>" class="btn btn-primary action-button" id="submit_button" />
    <input type="button" value="<?php echo $mod_strings['LBL_ML_CANCEL'];?>" class="btn btn-danger" onClick="location.href='index.php?module=Administration&action=UpgradeWizard&view=module';"/>
</div>

<?php

if ($remove_tables == 'prompt' && $mode == 'Uninstall') {
    print("<div class='d-flex align-items-center gap-2 mt-2'>");
