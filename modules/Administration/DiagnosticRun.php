...
function finishDiag()
{
    ...
    print "<a class=\"btn btn-primary\" href=\"index.php?module=Administration&action=DiagnosticDownload&guid=$sod_guid&time=$curdatetime&to_pdf=1\">".$mod_strings['LBL_DIAGNOSTIC_DOWNLOADLINK']."</a>";

    deleteDir($cacheDir);

    print "<a class=\"btn btn-danger\" href=\"index.php?module=Administration&action=DiagnosticDelete&file=diagnostic".$curdatetime."&guid=".$sod_guid."\">".$mod_strings['LBL_DIAGNOSTIC_DELETELINK']."</a>";
    print "</div";
}
