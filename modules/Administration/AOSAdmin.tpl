...
<div class="setup-system-wrap">
    <div class="box-section">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
            ...
            <tr>
                <td  scope="row" width="20%">{$MOD.LBL_AOS_ADMIN_CONTRACT_RENEWAL_REMINDER}: </td>
                <td  >
    ...
    <div class="box-section">
        <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
            ...
            <tr>
                <td  scope="row" width="20%">{$MOD.LBL_AOS_ADMIN_INITIAL_INVOICE_NUMBER}: </td>
                <td  >
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            <td  scope="row" width="20%">{$MOD.LBL_AOS_ADMIN_INITIAL_QUOTE_NUMBER}: </td>
            <td  >
    ...
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
        ...
        <tr>
            <td  scope="row" width="20%">{$MOD.LBL_AOS_ADMIN_ENABLE_LINE_ITEM_GROUPS}: </td>
            ...
            <td  scope="row" width="20%">{$MOD.LBL_AOS_ADMIN_ENABLE_LINE_ITEM_TOTAL_TAX}: </td>
