...
<div class="box-section">
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="table-view table-config table-AOPAdmin">
        <thead>
            <tr><th align="left" scope="row" colspan="4"><h4 class="sub-admin__title">{$MOD.LBL_AOP_JOOMLA_SETTINGS}</h4></th></tr>
        </thead>
        <tbody>
            <tr>
...
<div class="box-section" id='distribution_settings'>
    <table width="100%" border="0" cellspacing="1" cellpadding="0" class="table-view table-config table-AOPAdmin">
        <thead>
            <tr><th align="left" scope="row" colspan="4"><h4 class="sub-admin__title">{$MOD.LBL_AOP_CASE_ASSIGNMENT}</h4></th></tr>
        </thead>
        <tbody>
            <tr>
...
<div class="box-section" id='case_status_settings'>
    <table border="0" cellspacing="1" cellpadding="0" class="table-view table-config table-AOPAdmin">
        <thead>
            <tr>
                <th align="left" scope="row" colspan="4"><h4 class="sub-admin__title">{$MOD.LBL_AOP_CASE_STATUS_SETTINGS}</h4></th>
            </tr>
        </thead>
        <tbody>
            {$currentStatuses}
            <tr><td><button class="btn btn-primary" type='button' id="addStatusButton">{$MOD.LBL_AOP_ADD_STATUS}</button></td></tr>
        </tbody>
    </table>
</div>

<div class="box-section" id='email_settings'>
    <table border="0" cellspacing="1" cellpadding="0" class="table-view table-config table-AOPAdmin">
        <thead>
            <tr><th align="left" scope="row" colspan="4"><h4 class="sub-admin__title">{$MOD.LBL_AOP_EMAIL_SETTINGS}</h4></th></tr>
        </thead>
        <tbody>
            <tr>
            ...
            <tr id="user_email_template_row">
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href='javascript:open_email_template_form("user_email_template_id")' >{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                    <span name='edit_template' id='user_email_template_id_edit_template_link' style='visibility: hidden;'>
                    <a class="btn btn-info" href='javascript:edit_email_template_form("user_email_template_id")' >{$MOD.LBL_EDIT_EMAIL_TEMPLATE}</a></span>
                </td>
            </tr>
            ...
            <tr id="contact_email_template_row">
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href='javascript:open_email_template_form("contact_email_template_id")' >{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                    <span name='edit_template' id='contact_email_template_id_edit_template_link' style='visibility: hidden;'>
                    <a class="btn btn-info" href='javascript:edit_email_template_form("contact_email_template_id")' >{$MOD.LBL_EDIT_EMAIL_TEMPLATE}</a></span>
                </td>
            </tr>
            <tr id="case_creation_email_template_row">
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href='javascript:open_email_template_form("case_creation_email_template_id")' >{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                    <span name='edit_template' id='case_creation_email_template_id_edit_template_link' style='visibility: hidden;'>
                    <a class="btn btn-info" href='javascript:edit_email_template_form("case_creation_email_template_id")' >{$MOD.LBL_EDIT_EMAIL_TEMPLATE}</a></span>
                </td>
            </tr>
            ...
            <tr id="case_closure_email_template_row">
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href='javascript:open_email_template_form("case_closure_email_template_id")' >{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                    <span name='edit_template' id='case_closure_email_template_id_edit_template_link' style='visibility: hidden;'>
                    <a class="btn btn-info" href='javascript:edit_email_template_form("case_closure_email_template_id")' >{$MOD.LBL_EDIT_EMAIL_TEMPLATE}</a></span>
                </td>
            </tr>
            ...
            <tr id="joomla_account_creation_email_template_row">
                ...
                <td>
                    ...
                    <a class="btn btn-primary" href='javascript:open_email_template_form("joomla_account_creation_email_template_id")' >{$MOD.LBL_CREATE_EMAIL_TEMPLATE}</a>
                    <span name='edit_template' id='joomla_account_creation_email_template_id_edit_template_link' style='visibility: hidden;'>
                    <a class="btn btn-info" href='javascript:edit_email_template_form("joomla_account_creation_email_template_id")' >{$MOD.LBL_EDIT_EMAIL_TEMPLATE}</a></span>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="actionsContainer">
        <tr>
            <td>
                {$BUTTONS}
            </td>
