...
<div id="EditView_tabs" class="yui-navset">
    <ul class="admin_tabs-list yui-nav">
        <li class="admin_tabs-item selected"><a id="tab1" href="#tab1">{$MOD.LBL_USER_INFORMATION}</a></li>
        <li class="admin_tabs-item" {if $CHANGE_PWD == 0}style='display:none'{/if}><a id="tab2" href="#tab2">{$MOD.LBL_CHANGE_PASSWORD_TITLE}</a></li>
        {if $SHOW_THEMES}
        	<li class="admin_tabs-item"><a id="tab3" href="#tab3" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>{$MOD.LBL_THEME}</a></li>
        {/if}
        <li class="admin_tabs-item"><a id="tab4" href="#tab4" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>{$MOD.LBL_ADVANCED}</a></li>
        {if $ID}
        <li class="admin_tabs-item"><a id="tab5" href="#tab5" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>{$MOD.LBL_EAPM_SUBPANEL_TITLE}</a></li>
        {/if}
		<li class="admin_tabs-item"><a id="tab6" href="#tab6" style='display:{$HIDE_FOR_GROUP_AND_PORTAL};'>{$MOD.LBL_LAYOUT_OPTIONS}</a></li>
    </ul>
