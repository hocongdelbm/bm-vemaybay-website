...
$dictionary['EC_Flight_Bookings'] = array(
    ...
    'fields' => array(
        ...
        'external_request_id' => array(
            'name'       => 'external_request_id',
            'vname'      => 'LBL_EXTERNAL_REQUEST_ID',
            'type'       => 'varchar',
            'len'        => 36,
            'required'   => false,
            'importable' => false,
        ...
        'external_payload_hash' => array(
            'name'       => 'external_payload_hash',
            'vname'      => 'LBL_EXTERNAL_PAYLOAD_HASH',
            'type'       => 'varchar',
            'len'        => 64,
            'required'   => false,
            'importable' => false,
    ...
    'indices' => array(
        ...
        array('name' => 'idx_bk_external_request_id', 'type' => 'unique', 'fields' => array('external_request_id')),
    ),
    'relationships' => array(),
