...
trait PassengerTrait
{
	 ...
	 * of showing the cic/passport_number value directly.
	 */
	private function renderPassportInfoTrigger($row)
	{
		$displayValue = !empty($row['passport_number']) ? $row['passport_number'] : ($row['cic'] ?? '');
