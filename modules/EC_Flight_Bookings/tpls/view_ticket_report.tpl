    ...
    <script>
        $(document).ready(function () {
            ...
            $("#btnClear").click(function() {
                $("#frmSearch input:not([type=submit], [type=button], [type=hidden]), #frmSearch select").val("");
            });
...
<div class="ticket_report--wrap">
    <div class="box-section">
        <form action="index.php" method="post" name="frmSearch" id="frmSearch" class="position-relative">
            <input type="hidden" name="module" value="EC_Flight_Bookings"/>
            <input type="hidden" name="action" value="ticketreport"/>
            
            <div class="from-to-date--wrap d-inline-flex gap-3 align-items-center mb-3">
                ...
                <div class="d-flex align-items-center gap-2">
                    <input type="submit" id="btnSearch" value="Tìm kiếm" name="btnSearch" class="btn btn-primary" title="Tìm"/>
            ...
            <div class="d-flex align-items-center gap-2 optionRadio--wrap">
                ...
                <div class="d-flex align-items-center gap-2 ms-4">
                    <div class="new_line">Tìm nâng cao:</div>&nbsp; 
                    Tình trạng thu: 
                    <select class="box-select" name="payment_stt">{$PAYMENT_STT}</select>
                </div>
            </div>
...
<div class="box-section">
    <table id="total_ticket_report_tbl" cellpadding="0" cellspacing="0" class="table-total-sale__booking table-details__booking">
        <thead>
            <tr class="head">
                {if $IS_ALLOW_RECHECK}
                    <th align="center" width="2%"><input type="checkbox" id="check-all" value="0"></th>
                {/if}
                <th align="center" width="3%">STT</th>
                <th align="center" width="10%">Booking</th>
                <th align="center" width="3%">Vé</th>
                <th align="center" width="18%">Ghi chú</th>
                <th align="center" width="8%">Doanh thu</th>
                <th align="center" width="8%">Giá mua</th>
                <th align="center" width="8%">Doanh số</th>
                <!-- <th align="center" width="7%" class="hide-mobile">Nơi đặt</th> -->
                <th align="center" width="8%">Phiếu thu</th>
                <th align="center" width="12%" class="hide-mobile">Nhân viên</th>
                <th align="center" width="10%">Ngày tạo</th>
                <th align="center">Ngày xuất vé</th>
            </tr>
        </thead>
        <tbody>
            {$DATA}
