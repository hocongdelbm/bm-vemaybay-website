...
{literal}
	...
	.remaining-credit span.loading{
		background:url(themes/SuiteP/images/loading.gif) left center no-repeat;
		width:16px;
		height:16px;
...
<div id="top-area">
	<form action="index.php" method="post" name="frmSearch" id="frmSearch">
		...
		<div class="from-to-date--wrap d-inline-flex gap-2 align-items-center mb-3">
			...
			<input type="submit" id="btnView" name="btnView" class="ms-3 btn btn-primary" value="Xem" title="Xem" />
		</div>
	</form>
</div>

{if $IS_ADMIN || $ALL}
<table class="list-data list-data-all table-details__booking" cellpadding="0" cellspacing="0">
	<thead>
		<tr>
			<th width="3%">STT</th>
			...
			<th width="9%" align="center"><span title="Tổng cộng">Tổng cộng</span></th>
	</tr>
	</thead>
    {$ADMIN_DATA}
	<tr class="footer-tr">
