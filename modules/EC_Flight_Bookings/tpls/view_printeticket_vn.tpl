                ...
                <td>
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-1" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                        <tbody>
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; margin-bottom: 15px; width: 900px;" width="900">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" style=" font-size: 14px;font-weight: 400;text-align: left;padding-bottom: 5px;padding-top: 5px;vertical-align: middle;border: 0px;" width="35%">
                                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block block-1" role="presentation" style=" font-size: 14px;" width="100%">
                                                        <tr>
                                                            ...
                                                            <td class="pad" style="padding-bottom: 5px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class="" style="font-size: 15px; font-family:Arial, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; line-height: 1.5; ">
                                                                        ...
                                                                        <p style="margin: 0; text-align: right; mso-line-height-alt: 14.399999999999999px; ">
                                                                            <span style="color: #000"><strong>Hỗ trợ: {$COM_TOP_PHONE}</strong></span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                            ...
                            <tr>
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content" role="presentation" style=" mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; width: 900px; padding: 0 5px 10px;font-size: 14px;" width="900">
                                        <thead>
                                            <tr>
                                                <th width="30%" align="left" style="font-weight:bold;border:1px solid #ccc; padding: 10px 7px;text-align:center;">Tên Hành Khách</th>
                                                <th width="20%" align="left" style="font-weight:bold;border:1px solid #ccc; padding: 10px 7px;text-align:center;">Mã Đặt Chỗ</th>
                                                <th width="50%" align="left" style="font-weight:bold;border:1px solid #ccc; padding: 10px 7px;text-align:center;">Hành Lý Ký Gửi</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {$LIST_OF_PASSENGER}
                                                        ...
                                                        <tr>
                                                            <td class="pad" style=" width: 100%; padding-right: 0px; padding-left: 0px; padding-top: 15px; ">
                                                                ...
                                                                <ul style="line-height: 25px; margin: 0px;list-style-type: square;padding: 10px; color: #000;">
                                                                    <li>
                                                                        Quý khách cần kiểm tra thông tin kỹ càng trước khi ra sân bay. Họ tên hành khách, hành lý, ngày giờ bay, điểm đi - đến. Giấy tờ tuỳ thân khi ra sân bay phải là bản chính.
                                                                    </li>
                                                                    <li>
                                                                    ...
                                                                    <li>
                                                                        Vé khuyến mãi không hoàn đổi! Xin lưu ý điều này.
                                                                    </li>
                                                                    <li>
