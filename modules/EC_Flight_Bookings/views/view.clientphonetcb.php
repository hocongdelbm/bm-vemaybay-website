...
//         $source = isset($_GET['source']) ? $_GET['source'] : 'dailyve.net';
...
class Viewclientphonetcb extends SugarView
{
    function display()
    {
        ...
        $sources = ['timchuyenbay.vn', 'dailyve.net', 'timchuyenbay.com'];  // List of possible sources
