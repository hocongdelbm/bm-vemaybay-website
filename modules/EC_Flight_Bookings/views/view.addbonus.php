...
class Viewaddbonus extends SugarView {
	function display() {
		if(ACLController::checkAccess('EC_Flight_Bookings', 'edit', true)){
			...
			$smartyCont->display('modules/EC_Flight_Bookings/tpls/view_addbonus.tpl');
		} else {
	...
	function populateContent($smartyobj) {
		...
		if(isset($_POST['btnSaveBonus'])) {
			...
			header('Location: index.php?module=EC_Flight_Bookings&action=addbonus&from_date='.$from_date_value.'&to_date='.$to_date_value);
			exit;
		}
	}
