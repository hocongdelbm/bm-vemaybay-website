...
$form_top = <<<EOQ
            ...
            <div class="d-flex align-items-center gap-2 mt-3">
			    <input title="$button_title" class="btn btn-primary" onclick="return verify_selection(this);" type="submit" name="button" value="  $button_label  " id="perform_merge_button">
                <input title="$cancel_title" accessKey="$cancel_key" class="btn btn-danger" onclick="this.form.action.value='DetailView';this.form.module.value='$focus->merge_module';this.form.module.record='$return_id'" type="submit" name="button" value=" $cancel_label   " id="cancel_merge_button" >
            </div>
		</form>
        <script>
