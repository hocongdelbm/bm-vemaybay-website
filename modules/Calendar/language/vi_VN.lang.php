...
$mod_strings = array(
    ...
    'LBL_STYLE_BASIC' => 'Cơ bản', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_STYLE_ADVANCED' => 'Nâng cao', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template

    'LBL_NO_USER' => 'Không khớp trường dữ liệu: Được giao cho',
    'LBL_SUBJECT' => 'Chủ đề',
