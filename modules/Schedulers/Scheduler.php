...
class Scheduler extends SugarBean
{
    ...
    public function displayCronInstructions()
    {
        ...
        if (is_windows()) {
            ...
            echo '
                <table cellpadding="0" cellspacing="0" border="0" class="table-cron-instruction__linux">
                <tr height="20">
                    <th><h4 class="sub-admin__title">' . $mod_strings['LBL_CRON_INSTRUCTIONS_WINDOWS'] . '</h4>
                    </th>
                </tr>
            ...
            echo '
                <table cellpadding="0" cellspacing="0" border="0" class="table-cron-instruction__linux">
                <tr height="20">
                    <th><h4 class="sub-admin__title">' . $mod_strings['LBL_CRON_INSTRUCTIONS_LINUX'] . '</h4></th>
                </tr>
                <tr>
