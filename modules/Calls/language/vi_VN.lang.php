...
$mod_strings = array(
    ...
    'LBL_CALL_INFORMATION' => 'Thông tin cuộc gọi', //No need to be translated in all caps. Translation used just in menu action items when using the SuiteP template
    'LBL_REMOVE' => 'Xóa bỏ',
