...
$mod_strings = array(
    ...
    'LBL_EMAIL_WARNING_NOTIFICATIONS' => 'Email cảnh báo',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION_HELP' => 'Khi chọn tùy chọn này, tất cả người dùng sẽ có thể gửi email sử dụng cùng một tài khoản mail gửi điđể gửi thông báo và cảnh báo hệ thống.<br>Nếu tùy chọn không được chọn, người dùng vẫn có thể sử dụng máy chủ thư đi sau khi cung cấp thông tin tài khoản của riêng họ.',
