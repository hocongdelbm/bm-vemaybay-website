...
{/literal}
{$ROLLOVER}
<form name="ConfigureSettings" class="frm-config" id="EditView" method="POST" >
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" class="mb-3">
	<tr>
		<td>
			<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accessKey="{$APP.LBL_SAVE_BUTTON_KEY}" class="btn btn-primary" onclick="this.form.action.value='Save';return verify_data(this);" type="submit" name="button" id="btn_save" value=" {$APP.LBL_SAVE_BUTTON_LABEL} ">
			<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" accessKey="{$APP.LBL_CANCEL_BUTTON_KEY}" class="btn btn-danger" onclick="this.form.action.value='{$RETURN_ACTION}'; this.form.module.value='{$RETURN_MODULE}';" type="submit" name="button" value=" {$APP.LBL_CANCEL_BUTTON_LABEL} ">
		</td>
	...
	<div class="panel-content">
		<div class="panel panel-default">
			<div class="panel-heading">
				<a href="#config_mail" role="button" data-bs-toggle="collapse" aria-expanded="false">
					{$MOD.LBL_EMAIL_OUTBOUND_CONFIGURATION}
				</a>
			</div>
			<div class="panel-body collapse show" id="config_mail">
				<div class="tab-content">
					<div class="row">
						<div class="col-md-12">
							<div class="row mb-3">
								<div class="col-md-12">
								 	<span class="label">{$MOD.LBL_OUTGOING_SECTION_HELP}</span>	
								</div>
							</div>
						</div>
						<div class="col-md-6 ">
							<div class="row mb-3">
								<div class="col-md-4">
									<span class="label">{$MOD.LBL_NOTIFY_FROMNAME} <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></span>
								</div>
								<div class="col-md-8">
									<input id='notify_fromname' name='notify_fromname' tabindex='1' size='25' maxlength='128' type="text" value="{$notify_fromname}">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row mb-3">
								<div class="col-md-4">
									<span class="label">{$MOD.LBL_NOTIFY_FROMADDRESS} <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span></span>
								</div>
								<div class="col-md-8">
									<input id='notify_fromaddress' name='notify_fromaddress' tabindex='1' size='25' maxlength='128' type="text" value="{$notify_fromaddress}">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row mb-3">
								...
								<div class="col-md-8">
									<div id="smtpButtonGroup" class="yui-buttongroup d-flex gap-1 align-items-center">
										<span id="gmail" class="yui-button yui-radio-button{if $mail_smtptype == 'gmail'} yui-button-checked{/if}">
											<button type="button" name="mail_smtptype" value="gmail" class="btn btn-primary">
										...
										<span id="exchange" class="yui-button yui-radio-button{if $mail_smtptype == 'exchange'} yui-button-checked{/if}">
											<button type="button" name="mail_smtptype" value="exchange" class="btn btn-info">
										...
										<span id="other" class="yui-button yui-radio-button{if $mail_smtptype == 'other' || empty($mail_smtptype)} yui-button-checked{/if}">
											<button type="button" name="mail_smtptype" value="other" class="btn btn-secondary">
						...
						<div class="col-md-6">
							<div class="row mb-3 {$OUTBOUND_TYPE_CLASS}">
								<div class="col-md-4">
									<span class="label">{$MOD.LBL_MAIL_SENDTYPE}</span>
								</div>
								<div class="col-md-8">
						...
						<div class="col-md-12">
							<div class="row" id="smtp_settings">
								<div class="col-md-12">
									<div class="row mb-3" id="mailsettings1">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<span class="label" id="mail_smtpserver_label">{$MOD.LBL_MAIL_SMTPSERVER}</span> <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
												</div>
												<div class="col-md-8">
													<input type="text" id="mail_smtpserver" name="mail_smtpserver" tabindex="1" size="25" maxlength="255" value="{$mail_smtpserver}">
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<span class="label" id="mail_smtpport_label">{$MOD.LBL_MAIL_SMTPPORT}</span> <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
												</div>
												<div class="col-md-8">
													<input type="text" id="mail_smtpport" name="mail_smtpport" tabindex="1" size="5" maxlength="5" value="{$mail_smtpport}">
												</div>
											</div>
										</div>
									</div>
								...
								<div class="col-md-12">
									<div class="row mb-3" id="mailsettings2">
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<span class="label" id='mail_smtpauth_req_label'>{$MOD.LBL_MAIL_SMTPAUTH_REQ}</span>
												</div>
												<div class="col-md-8">
													<input id='mail_smtpauth_req' name='mail_smtpauth_req' type="checkbox" class="checkbox" value="1" tabindex='1' onclick="notify_setrequired(document.ConfigureSettings);" {$mail_smtpauth_req}>
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="row">
												<div class="col-md-4">
													<span class="label" id="mail_smtpssl_label">{$APP.LBL_EMAIL_SMTP_SSL_OR_TLS}</span>
												</div>
												<div class="col-md-8">
								...
								<div class="col-md-12">
									<div class="row mb-3">
										<div class="col-md-6">
											<div class="row" id="smtp_auth1">
												<div class="col-md-4">
													<span class="label" id="mail_smtpuser_label">{$MOD.LBL_MAIL_SMTPUSER}</span> <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
												</div>
												<div class="col-md-8">
													<input type="text" id="mail_smtpuser" name="mail_smtpuser" size="25" maxlength="255" value="{$mail_smtpuser}" tabindex='1' >
												</div>
											</div>
										</div>
										<div class="col-md-6">
											<div class="row" id="smtp_auth2">
												<div class="col-md-4">
													<span class="label" id="mail_smtppass_label">{$MOD.LBL_MAIL_SMTPPASS}</span> <span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
												</div>
												<div class="col-md-8">
						...
						<div class="col-md-12">
							<div class="row mb-3" id="mail_allow_user">
								<div class="col-md-4">
									<span class="label">
						...
						<div class="col-md-12">
							<div class="row mb-3 legacy-compose-option" {if isset($legacyEmailConfigEnabled)}style="display:none"{/if}>
								<div class="col-md-4">
									<span class="label">
						...
						<div class="col-md-12">
							<input type="button" class="btn btn-info" value="{$APP.LBL_EMAIL_TEST_OUTBOUND_SETTINGS}" onclick="testOutboundSettings();">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<a href="#customize_mail" role="button" data-bs-toggle="collapse" aria-expanded="false">
					{$MOD.LBL_NOTIFY_TITLE}
				</a>
			</div>
			<div class="panel-body collapse show" id="customize_mail">
				<div class="tab-content">
					<div class="row">
						<div class="col-md-12">
							<div class="row mb-3">
								<div class="col-md-4">
									<span class="label">{$MOD.LBL_NOTIFY_ON}:</span>&nbsp;
						...
						<div class="col-md-12">
							<div class="row mb-3">
								...
								<div class="col-md-8">
									<input type='hidden' name='notify_send_from_assigning_user' value='0'>
									<input name='notify_send_from_assigning_user' value="2" tabindex='1' class="checkbox" type="checkbox" {$notify_send_from_assigning_user}>
								</div>
							</div>
						</div>
		...
		<div class="panel panel-default">
			<div class="panel-heading ">
				<a href="#securety_mail" role="button" data-bs-toggle="collapse" aria-expanded="false">
					{$MOD.LBL_SECURITY_TITLE}
				</a>
			</div>
			<div class="panel-body collapse show" id="securety_mail">
				<div class="tab-content">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-edit table-config table-securety_mail">
						<tr>
...
<div id="testOutboundDialog" class="yui-hidden">
    <div id="testOutbound">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-edit table-config table-testOutbound">
			<tr>
				<td scope="row">
					<span class="label">
			...
			<tr>
				<td>
					<input class="w-100" type="text" id="outboundtest_from_address" name="outboundtest_from_address" size="35" maxlength="64" value="{$CURRENT_USER_EMAIL}">
				</td>
			</tr>
			<tr>
...
<table width="100%" cellpadding="0" cellspacing="0" border="0">
	<tr>
		<td>
			<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" class="btn btn-primary" onclick="this.form.action.value='Save';return verify_data(this);" type="submit" name="button" value=" {$APP.LBL_SAVE_BUTTON_LABEL} ">
			<input title="{$APP.LBL_CANCEL_BUTTON_TITLE}" class="btn btn-danger" onclick="this.form.action.value='{$RETURN_ACTION}'; this.form.module.value='{$RETURN_MODULE}';" type="submit" name="button" value=" {$APP.LBL_CANCEL_BUTTON_LABEL} ">
		</td>
	</tr>
</table>
